...
curvePaletteController = None # Little cheat, to make the assistant available from the window
...
class Typolator(Subscriber):
    ...
    def build(self):
        ...
        self.foregroundContainer = glyphEditor.extensionContainer(
            identifier="com.roboFont.TYPETR-Typolator.foreground",
            location="foreground",
            clear=True
        )
        self.backgroundContainer = glyphEditor.extensionContainer(
            identifier="com.roboFont.TYPETR-Typolator.background",
            location="background",
            clear=True
        )
        # Released glyph TTF instance, if md.releasedPath is defined.
        self.interpolationGlyphOverlay = []
        for pIndex in range(30):
            self.interpolationGlyphOverlay.append(self.backgroundContainer.appendPathSublayer(
                position=(FAR, 0),
                fillColor=None,
    ...
    def fontDidOpen(self, info):
        print('Subcriber-fontDidOpen')
        
    def fontWillClose(self, info):
        print('Subcriber-fontWillClose')
        
    def fontDidClose(self, info):
        print('Subcriber-fontDidClose')
        
    def glyphEditorDidSetGlyph(self, info):
        # Pass this on to the window controller. How to do this better?
        print('Subscriber-glyphEditorDidSetGlyph')
        self.controller.glyphEditorDidSetGlyph(info)

    def glyphEditorDidMouseUp(self, info):
        # Pass this on to the window controller. How to do this better?
        print('Subscriber-glyphEditorDidMouseUp')
        self.controller.glyphEditorDidMouseUp(info)

    def glyphEditorDidMouseDrag(self, info):
        # Pass this on to the window controller. How to do this better?
        print('Subscriber-glyphEditorDidMouseDrag')
        self.controller.glyphEditorDidMouseDrag(info)

    def glyphEditorGlyphDidChangeSelection(self, info):
        # Pass this on to the window controller. How to do this better?
        print('Subscriber-glyphEditorGlyphDidChangeSelection')
        self.controller.glyphEditorGlyphDidChangeSelection(info)

    def currentFontDidSetFont(self, info):
        print('Subscriber-currentFontDidSetFont')

    def fontDocumentDidOpen(self, info):
        print('Subscriber --- fontDocumentDidOpen', info.keys())
        
    def fontDocumentWindowDidOpen(self, info):
        print('Subscriber --- fontDocumentWindowDidOpen', info.keys())

    def fontDocumentWillClose(self, info):
        print('Subscriber --- fontDocumentWillClose', info['font'].path)

    def fontDocumentWillOpen(self, info):
        print('Subscriber-fontDocumentWillOpen')
        
    def fontDocumentWindowDidOpen(self, info):
        print('Subscriber-fontDocumentWindowDidOpen')
        self.controller.updateRefPopup()
        self.controller.updateUfoListCallback()

    def fontDocumentWindowWillClosen(self, info):
        print('Subscriber-fontDocumentWindowWillClosen')
                
    def fontDocumentWindowDidClosen(self, info):
        print('Subscriber-fontDocumentWindowWillClosen')
                
    def fontDocumentWillClose(self, info):
        print('Subscriber-fontDocumentWillClose')
...
class TypolatorController(WindowController):
    ...
    def glyphEditorDidSetGlyph(self, info):
        # Pass this on to the window controller. How to do this better?
        print('Controller-glyphEditorDidSetGlyph')
        pass
        
    def glyphEditorDidMouseUp(self, info):
        # Pass this on to the window controller. How to do this better?
        print('Controller-glyphEditorDidMouseUp')
        pass

    def glyphEditorDidMouseDrag(self, info):
        # Pass this on to the window controller. How to do this better?
        print('Controller-glyphEditorDidMouseDrag')
        pass

    def glyphEditorGlyphDidChangeSelection(self, info):
        # Pass this on to the window controller. How to do this better?
        print('Controller-glyphEditorGlyphDidChangeSelection')
        pass
    ...
    def fontDocumentWindowWillOpen(self, info):
        print('Controller-fontDocumentWindowWillOpen')
                
    def fontDocumentWindowDidOpen(self, info):
        print('Controller-fontDocumentWindowDidOpen')

    def fontDocumentWindowWillClosen(self, info):
        print('Controller-fontDocumentWindowWillClosen')
