...
class MerzInteractiveView(merz.MerzView):
    def mouseDown(self):
        print("aa")
...
class GlyphVisualizer(Subscriber):
    ...
    def build(self):
        ...
        self.w = vanilla.FloatingWindow((400, 800), "Glyph Visualizer", minSize=(50, 300))
        self.merzView = MerzInteractiveView("auto")
