...
class BogieAssistant(Subscriber):
    ...
    def update(self, g):
        ...
        tankCompartiments = (-1317, -1017, -170, 170, 886, 1226, 2983, 4740, 5080, 5796, 6136, 6983, 7283)
...
class BogieAssistantController(WindowController):
    ...
    def build(self):        
        ...
        y += L
        self.w.overlay = EditText((C0, y, CW, 24), 'tankSide.side', callback=self.updateEditorCallback)
