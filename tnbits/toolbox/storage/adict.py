...
class A(object):
    ...
    def __eq__(self, other):
        """Answer whether self is equal to other.
    ...
    def __ne__(self, other):
        """Answer whether self is not equal to other."""
...
class AList(A):
    """The AList (AttributeList) is the replacement of any list, to make sure that the
...
class ADict(A):
    """The ADict (AttributeDict) is an improved version of State.  The main
    ...
    _RESERVEDNAMES = set(('_data_', 'asDict', 'fromDict', 'asSource', 'fromSource',
        'get', 'keys', 'items', 'values', '_RESERVEDNAMES'))

    def __init__(self, d=None):
        """Set the internal dict to *d*. This is assumed to be an instance with dictionary behavior.
    ...
    def asDict(self):
        """Answer the internal dictionary.
    ...
    def keys(self):
        """Answer the keys of the internal dictionary.
    ...
    def items(self):
        """Answer the items of the internal dictionary, where dict and list values are wrapped.
    ...
    def values(self):
        """Answer the values of the internal dictionary, where dict and list values are wrapped.
    ...
    def get(self, name, default=None):
        """Answer the value of *name*. Answer *default* of the key does not exist. Dict and list values are wrapped.
    ...
    def __contains__(self, key):
        """Answers if the the internal dictionary contains the key.
    ...
    def __getitem__(self, name):
        """Answer the named value. Internal dict, tuple and list instances get translated to
    ...
    def __setitem__(self, name, value):
        """Set the named value in the internal dictionary. If the (external) value
    ...
    def __getattr__(self, name):
        """Answer the named attribute. If the answered value is a dictionary,
    ...
    def __setattr__(self, name, value):
        """Set the named attribute. If the value is an ADict, then copy the value by name.
...
def _runDocTests():
    import doctest
    import tnbits.toolbox.storage.adict
    return doctest.testmod(tnbits.toolbox.storage.adict)
