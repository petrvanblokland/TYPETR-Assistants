...
class SegoeSubsetter(Subsetter):
    ...
    def subsetGSUB(self, weight, style, script, targetFont, targetGlyphNames, modelFont):
        ...
        for glyphName in set(targetGSUB.getInputGlyphNames()):
            ...
            """
            if glyphName == 'afii57664':
                print('Deleted afii57664', targetFont[glyphName], targetFont[glyphName], glyphName in targetGlyphNames)
        ...
        print('glyphs', len(targetGlyphNames))
        print('scripts', len(targetGSUB.scripts))
        print('languages', len(targetGSUB.languages))
        features = targetGSUB.features
        print('features', len(features))
        lookups = targetGSUB.lookups
        print('lookups', len(lookups))
        print('inputGlyphNames', len(targetGSUB.getInputGlyphNames()), targetGSUB.getInputGlyphNames())
        print('glyphNames', len(targetGSUB.getGlyphNames()), targetGSUB.getGlyphNames())
        print('afii57664', targetFont['afii57664'].unicode)
        aa = 223
    ...
    def subsetFont(self, targetFont, modelFont, fallbackFont, weight, style, script, glyphset):
        ...
        # expanded component glyphs of the unicode glyphs. In princple this list should be enough as input
