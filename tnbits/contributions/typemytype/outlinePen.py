...
from fontTools.pens.reverseContourPointPen import ReverseContourPen
...
def pointOnACurve(p0, c0, c1, c2, value):
    x1, y1 = p0
    cx1, cy1 = c0
    cx2, cy2 = c1
    x2, y2 = c2
...
class OutlinePen(BasePen):
    ...
    def drawPoints(self, pointPen):
        if self.drawInner:
            reversePen = ReverseContourPen(pointPen)
        ...
        if self.drawOriginal:
            if self.drawOuter:
                pointPen = ReverseContourPen(pointPen)
