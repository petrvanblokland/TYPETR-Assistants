...
class Glyphs(object):
    ...
    GLYPHNAME_SUFFIXORDER = ['numr', 'dnom', 'uc', 'lc', 'sc', 'smcp', 'nc', 'pc', 'tab', 'tnum', 'thin', 'em', 'en', 'prop', 'pnum', 'onum', 'lnum', 'sups', 'sinf', 'ordn', 'subs', 'isol', 'init', 'medi', 'fina', 'alt', 'salt', 'calt', 'swsh', 'unic', 'long', 'short', 'n', 'nw', 'w', 's', 'se', 'e', 'ne']
