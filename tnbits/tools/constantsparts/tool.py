...
class Tool:
    ...
    # Some standard stuff for layouts
    UNIT = 10
    GUTTER = UNIT
    COLUMN = 8 * UNIT
    BUTTON_WIDTH = COLUMN
    ...
    L = 2*UNIT # Leading between components
    LL = 2*L
    LLL = 3*L
    LLLL = 4*L
    LLLLL = 5*L
    ...
    CATEGORIES = (
       CATEGORY_MANAGE, CATEGORY_DESIGN, CATEGORY_ANALYZE, CATEGORY_GENERALIZE,
       CATEGORY_PRODUCTIZE, CATEGORY_PUBLICIZE, CATEGORY_MONETIZE
    )
    ...
    EXTENSION_TTX = 'ttx'
    EXTENSION_SVG = 'svg'
    EXTENSIONS = (EXTENSION_UFO, EXTENSION_TTF, EXTENSION_EOT,
