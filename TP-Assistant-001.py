...
class TypolatorController(WindowController):
    ...
    def build(self):
        ...
        y = -VT
        self.w.openUfoInterface = vanilla.CheckBox((C0, y, CW, L), 'Open UFO Interface on DblClick', value=False, sizeStyle='small')
    ...
    def dblClickUfoNamesCallback(self, sender):
        ...
        for ufoIndex in ufoSelected:
            ...
            if self.w.selectOpenDblClick.get() == 0:
                f = getMaster(ufoPath, showInterface=self.w.openUfoInterface.get())
