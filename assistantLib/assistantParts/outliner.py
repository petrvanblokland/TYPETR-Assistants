...
# ..............................................................................
#
#   Simplified version of Outliner part, by Frederik Berlain.
#   We only need tube thicknes and minimal distance defined.
#
import sys
from math import *
#from vanilla import *
...
class OutlinePen(BasePen):
    ...
    def __init__(self, glyphSet, offset=10, contrast=0, contrastAngle=0, 
        connection=OL_SQUARE, cap=OL_ROUND, miterLimit=None, closeOpenPaths=True, 
...
def calculateOutline(g, thickness=20, contrast=0, contrastAngle=0, miterLimit=14,
        corner=OL_ROUND, cap=OL_ROUND, closeOpenPaths=True, drawOriginal=False, 
        drawInner=True, drawOuter=True, preserveComponents=True, expandedPoints=None):
