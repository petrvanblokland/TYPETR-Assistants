...
class AssistantPartAnchors(BaseAssistantPart):
    ...
    # Choices automatic XModes positions
    XMODES = ('X-Base', 'X-Box/2', 'X-Rom/Ita', 'X-Width/2', 'X-Manual')
    YMODES = ('Y-Diacritics', 'Y-Base', 'Y-Metrics', 'Y-Manual')
    ...
    def buildAnchors(self, y):
        ...
        c.w.anchorXModeTop = RadioGroup((C0, y, 3*CW, L), self.XMODES, isVertical=False, sizeStyle='small', callback=self.anchorModesCallback)
        c.w.anchorXModeTop.set(0)
        y += L
        c.w.anchorYModeTop = RadioGroup((C0, y, 3*CW*4/5, L), self.YMODES, isVertical=False, sizeStyle='small', callback=self.anchorModesCallback)
        c.w.anchorYModeTop.set(0)
        y += L
        c.w.anchorXModeMiddle = RadioGroup((C0, y, 3*CW, L), self.XMODES, isVertical=False, sizeStyle='small', callback=self.anchorModesCallback)
        c.w.anchorXModeMiddle.set(0)
        y += L
        c.w.anchorYModeMiddle = RadioGroup((C0, y, 3*CW*4/5, L), self.YMODES, isVertical=False, sizeStyle='small', callback=self.anchorModesCallback)
        c.w.anchorYModeMiddle.set(0)
        y += L
        c.w.anchorXModeBottom = RadioGroup((C0, y, 3*CW, L), self.XMODES, isVertical=False, sizeStyle='small', callback=self.anchorModesCallback)
        c.w.anchorXModeBottom.set(0)
        y += L
        c.w.anchorYModeBottom = RadioGroup((C0, y, 3*CW*4/5, L), self.YMODES, isVertical=False, sizeStyle='small', callback=self.anchorModesCallback)
        c.w.anchorYModeBottom.set(0)
        y += L
        c.w.anchorXModeOgonek = RadioGroup((C0, y, 3*CW, L), self.XMODES, isVertical=False, sizeStyle='small', callback=self.anchorModesCallback)
        c.w.anchorXModeOgonek.set(0)
        y += L
        c.w.anchorYModeOgonek = RadioGroup((C0, y, 3*CW*4/5, L), self.YMODES, isVertical=False, sizeStyle='small', callback=self.anchorModesCallback)
        c.w.anchorYModeOgonek.set(0)
        y += L
        c.w.anchorXModeTonos = RadioGroup((C0, y, 3*CW, L), self.XMODES, isVertical=False, sizeStyle='small', callback=self.anchorModesCallback)
        c.w.anchorXModeTonos.set(0)
        y += L
        c.w.anchorYModeTonos = RadioGroup((C0, y, 3*CW*4/5, L), self.YMODES, isVertical=False, sizeStyle='small', callback=self.anchorModesCallback)
        c.w.anchorYModeTonos.set(0)
    ...
    def anchorModesCallback(self, sender):
        changed = False
        g = self.getCurrentGlyph()
        changed |= self.anchorXModes(g)
        changed |= self.anchorYModes(g)
        if changed:
            g.changed()

    def setAnchorXModes(self, g):
    ...
    def _getAnchorsXMode(self, g):
        """Answer the anchors positioning mode in X-direction, as stored in g.lib. Create it, if the entry does not exist."""
    ...
    def _fixGlyphAnchorsX(self, g):
        ...
        xMode = self._getAnchorsXMode(g) # Get the value stored in g.lib that indicates the mode to calculate the 
