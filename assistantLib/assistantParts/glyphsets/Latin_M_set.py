...
for GDS in (LATIN_M_SET, LATIN_M_SET_ITALIC):
    ...
    GDS['Ohorn'] = GD(name='Ohorn', uni=0x01A0, hex='01A0', c='Ơ', l='O', w='O', base='O', accents=['horncmb.uc'], anchorTopX='O', anchorTopY='O', anchors=['bottom', 'middle', 'top'], gid=353, comment='Ơ')
    ...
    GDS['Uhorndotbelow'] = GD(name='Uhorndotbelow', uni=0x1EF0, hex='1EF0', c='Ự', l='U', r='Uhorn', anchorTopY='U', rightMin='minRight', base='Uhorn', accents=['dotbelowcmb'], anchors=['bottom', 'top'], gid=1163, comment='Ự LATIN CAPITAL LETTER U WITH HORN AND DOT BELOW')
    GDS['Uhorngrave'] = GD(name='Uhorngrave', uni=0x1EEA, hex='1EEA', c='Ừ', l='U', r='Uhorn', anchorTopY='U', rightMin='minRight', base='Uhorn', accents=['gravecmb.uc'], anchors=['bottom', 'top'], gid=1157, comment='Ừ LATIN CAPITAL LETTER U WITH HORN AND GRAVE')
    GDS['Uhornhookabove'] = GD(name='Uhornhookabove', uni=0x1EEC, hex='1EEC', c='Ử', l='U', r='Uhorn', anchorTopY='U', rightMin='minRight', base='Uhorn', accents=['hookabovecmb.uc'], anchors=['bottom', 'top'], gid=1159, comment='Ử LATIN CAPITAL LETTER U WITH HORN AND HOOK ABOVE')
    GDS['Uhorntilde'] = GD(name='Uhorntilde', uni=0x1EEE, hex='1EEE', c='Ữ', l='U', r='Uhorn', anchorTopY='U', rightMin='minRight', base='Uhorn', accents=['tildecmb.uc'], anchors=['bottom', 'top'], gid=1161, comment='Ữ LATIN CAPITAL LETTER U WITH HORN AND TILDE')
