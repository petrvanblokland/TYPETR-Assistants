...
for GDS in (LATIN_M_SET, LATIN_M_SET_ITALIC):
    ...
    GDS['Uhorn'] = GD(name='Uhorn', uni=0x01AF, hex='01AF', c='Ư', l='U', anchorTopY='U', anchorTopX='U', rightMin='minRight', base='U', accents=['horncmb.uc'], anchors=['bottom', 'top'], gid=368, comment='Ư LATIN CAPITAL LETTER U WITH HORN')
    ...
    GDS['ringhalfright'] = GD(name='ringhalfright', uni=0x02BE, hex='02BE', c='ʾ', l=GD.CAT_CENTER, w=GD.CAT_ACCENT_WIDTH, srcName='ringcmb', isLower=True, gid=472)
    ...
    GDS['uhorn'] = GD(name='uhorn', uni=0x01B0, hex='01B0', c='ư', l='u', anchorTopY='u', anchorTopX='u', isLower=True, accents=['horncmb'], anchors=['bottom', 'top'], gid=369, comment='ư U WITH HORN, LATIN SMALL LETTER')
