...
CYRILLIC_SET = {
   ...
   'Semisoftsign-cy': GD(name='Semisoftsign-cy', uni=0x048C, hex='048C', c='Ҍ', r='Softsign-cy', base='Yat-cy', gid=785),
   ...
   'gehookstroke-cy': GD(name='gehookstroke-cy', uni=0x04FB, hex='04FB', c='ӻ', isLower=True, anchors=['top']),
   ...
   'kastroke-cy': GD(name='kastroke-cy', uni=0x049F, hex='049F', c='ҟ', r='k', l='hyphen', base='ka-cy', isLower=True, gid=804),
   ...
   'pe-cy.loclBGR': GD(name='pe-cy.loclBGR', base='umacron', isLower=True),
