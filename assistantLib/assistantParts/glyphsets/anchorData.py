...
class AnchorData:
    ...
    ANCHOR_ASCENDER_OFFSET = 120 # Offset down from box top, will be made negative.
    ANCHOR_BOXTOP_OFFSET = 120 # Offset down from box top, will be made negative.
    ANCHOR_CAP_OFFSET = 78 # Offset down, will be made negative, used in case .uc are on xHeight
    ...
    TOP_ANCHORS = {
        ...
        'ccedillaacute', 'ccircumflex', 'ccomb', 'cdotaccent', 'che-cy', 'chedieresis-cy', 'cheverticalstroke-cy', 'circumflexcomb', 'commaabovecomb', 'commaabovecmb', 
        ...
        'firsttonechinese', 'flenis', 'fmiddletilde', 'fpalatalhook', 'g', 'gacute', 'gbreve', 'gbridgeabovecomb', 'gcaron', 'gcircumflex', 'gcommaaccent', 
        ...
        'kdiagonalstroke', 'kdotbelow', 'kgreenlandic', 'kje-cy', 'klinebelow', 'kobliquestroke', 'koroniscomb', 'kpalatalhook', 'kstroke', 'kstrokediagonalstroke', 
        ...
        'omegapsilioxia', 'omegapsilioxiaypogegrammeni', 'omegapsiliperispomeni', 'omegapsiliperispomeniypogegrammeni', 'omegapsilivaria', 
        ...
        'pokrytiecomb-cy', 'ppalatalhook', 'psilioxia', 'psiliperispomeni', 'psilipneumatacomb-cy', 'psilivaria', 'pstroke', 'pstrokethroughdescender', 'q', 
        ...
        'rhoStrokeSymbol', 'rhodasia', 'rhopsili', 'righthalfringabovecomb', 'ringcomb', 'ringacutecomb', 'rinvertedbreve', 'rlinebelow', 
        ...
        'sdotbelowdotaccent', 'shha-cy', 'sigmaLunateDottedSymbol', 'sigmaLunateSymbol', 'smiddletilde', 'sobliquestroke', 'spalatalhook', 
    ...
    MIDDLE_ANCHORS = {
        'A', 'Aring', 'Aringacute', 'A-cy', 'AE', 'AEacute', 'AEmacron', 'Aacute', 'Abreve', 'Abreve-cy', 'Abreveacute', 'Abrevedotbelow', 
    ...
    BOTTOM_ANCHORS = {
        ...
        'num', 'o', 'o-cy', 'oacute', 'obreve', 'ocaron', 'ocircumflex', 'ocircumflexacute', 'ocircumflexdotbelow', 'ocircumflexgrave',
         ...
         'tdiagonalstroke', 'tdieresis', 'tdotaccent', 'tdotbelow', 'thstrikethrough', 'tlinebelow', 'tmiddletilde', 'u', 'u-cy', 'uacute', 'ubar', 
         'ubreve', 'ucaron', 'ucircumflex', 'ucircumflexbelow', 'udblgrave', 'udieresis', 'udieresis-cy', 'udieresisacute', 'udieresisbelow', 'udieresiscaron', 
    ...
    OGONEK_ANCHORS = {
        'A', 'Aring', 'Aringacute', 'E', 'I', 'O', 'U', 'a', 'e', 'i', 'o', 'u',
    ...
    DOT_ANCHORS = {
        'C', 'L', 'SigmaLunateReversedSymbol', 'c', 'h', 'l', 'oopen',
    }

    TOPLEFT_ANCHORS = {
        'A', 'E', 'H', 'I', 'O', 'Ohm', 'P', 'UpsilonhookSymbol', 'Y', 'Alpha',
    }
    ...
    _TOP_ANCHORS = {
        ...
        'commaabovecmb', 'commaabovecomb', 'commaaboverightcomb', 'commareversedabovecomb', 'commaturnedabovecomb', 'dasiapneumatacomb-cy', 
        ...
        'ringcomb', 'ringacutecomb', 'sacute.component', 'scaron.component', 'softsigncomb-cy', 'suspensioncomb', 'tcomb', 
    ...
    _BOTTOM_ANCHORS = {
    'testbelowcmb.uc',
    'acutebelowcomb', 'arrowdoublerightbelowcomb', 'arrowheadleftbelowcomb', 'arrowheadrightbelowcomb', 'arrowheadrightheadupbelowcomb', 
    ...
    'ringbelowcomb', 'ringhalfleftbelowcomb', 'ringhalfrightbelowcomb', 'seagullbelowcomb', 'snakebelowcomb', 'squarebelowcomb',  
