...
GREEK_SET = {
   ...
   'KaiSymbol': GD(name='KaiSymbol', uni=0x03CF, hex='03CF', c='Ϗ', l='H', r='K', base='K', gid=596),
   ...
   'beta': GD(name='beta', uni=0x03B2, hex='03B2', c='β', isLower=True, anchors=['bottom', 'top'], anchorTopY='TopY', anchorTopX='TopX', gid=567),
   ...
   'epsilon': GD(name='epsilon', uni=0x03B5, hex='03B5', c='ε', isLower=True, anchors=['bottom', 'top'], anchorTopY='TopY', anchorTopX='TopX', gid=570, comment='ε'),
