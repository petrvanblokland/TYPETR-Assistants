...
GREEK_SET = {
   ...
   'Omega': GD(name='Omega', uni=0x03A9, hex='03A9', c='Ω', l='O', r='O', anchors=['bottom', 'top'], gid=558),
   ...
   'rho': GD(name='rho', uni=0x03C1, hex='03C1', c='ρ', l='p', r='o', isLower=True, anchors=['top'], gid=582),
   ...
   'san': GD(name='san', uni=0x03FB, hex='03FB', c='ϻ', l='H.sc', r='H.sc', isLower=True, gid=640),
   ...
   'sigmaLunateSymbol': GD(name='sigmaLunateSymbol', uni=0x03F2, hex='03F2', c='ϲ', l='c', r='c', srcName='c', isLower=True, anchors=['bottom', 'middle', 'top'], gid=631),
