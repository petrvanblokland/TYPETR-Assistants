...
GREEK_SET = {
   ...
   'Epsilontonos': GD(name='Epsilontonos', uni=0x0388, hex='0388', c='Έ', l='comma', r='E', base='E', accents=['tonoscmb.uc'], anchors=['bottom', 'middle', 'top'], gid=528),
   'Eta': GD(name='Eta', uni=0x0397, hex='0397', c='Η', l='H', r='H', base='H', anchors=['bottom', 'middle', 'top'], gid=541),
   'Etatonos': GD(name='Etatonos', uni=0x0389, hex='0389', c='Ή', l='Y', r='H', base='H', accents=['tonoscmb.uc'], anchors=['bottom', 'middle', 'top'], gid=529),
   'Fei-coptic': GD(name='Fei-coptic', uni=0x03E4, hex='03E4', c='Ϥ', l='o', r='H', gid=617),
   'Gamma': GD(name='Gamma', uni=0x0393, hex='0393', c='Γ', l='L', r='L', srcName='L', anchors=['top'], gid=537),
   ...
   'Iotadieresis': GD(name='Iotadieresis', uni=0x03AA, hex='03AA', c='Ϊ', w='I', bl='I', base='I', accents=['dieresiscmb.uc'], anchors=['bottom', 'middle', 'top'], gid=559),
   'Iotatonos': GD(name='Iotatonos', uni=0x038A, hex='038A', c='Ί', l='Y', r='I', base='I', accents=['tonoscmb.uc'], anchors=['bottom', 'middle', 'top'], gid=530),
   ...
   'Sigma': GD(name='Sigma', uni=0x03A3, hex='03A3', c='Σ', l='summation', r='summation', gid=552),
   ...
   'Upsilondieresis': GD(name='Upsilondieresis', uni=0x03AB, hex='03AB', c='Ϋ', l='Upsilon', r='Upsilon', base='Y', accents=['dieresiscmb.uc'], anchors=['bottom', 'middle', 'top'], gid=560),
   ...
   'Upsilontonos': GD(name='Upsilontonos', uni=0x038E, hex='038E', c='Ύ', l='Y', r='Y', base='Y', accents=['tonoscmb.uc'], anchors=['bottom', 'middle', 'top'], gid=532),
   ...
   'tonos': GD(name='tonos', uni=0x0384, hex='0384', c='΄', w=0, base='tonoscmb', anchors=[], isLower=True, gid=524),
   'tonoscmb.uc': GD(name='tonoscmb.uc', w=0, isLower=True, srcName='acutecmb.uc', anchors=['_tonos'], gid=1709), # Capital tonos is right aligned on the tonos anchor.
   'tonoscmb': GD(name='tonoscmb', w=0, anchors=['_top', 'top'], srcName='gravecmb', isLower=True), # Lower case tonos just behaves as other diacritics
