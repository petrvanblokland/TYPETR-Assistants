...
GREEK_SET = {
   ...
   'Upsilontonos.sc': GD(name='Upsilontonos.sc', l='Upsilon.sc', r='Upsilon.sc', base='Upsilon.sc', accents=['tonoscmb'], anchors=['bottom', 'top']),
   ...
   'gamma': GD(name='gamma', uni=0x03B3, hex='03B3', c='γ', l='v', r='off', isLower=True, anchors=['bottom', 'top'], gid=568),
   ...
   'sigma': GD(name='sigma', uni=0x03C3, hex='03C3', c='σ', l='o', r='off', isLower=True, anchors=['bottom', 'top'], gid=584),
   ...
   'sigmafinal': GD(name='sigmafinal', uni=0x03C2, hex='03C2', c='ς', l='c', r='off', isLower=True, gid=583),
