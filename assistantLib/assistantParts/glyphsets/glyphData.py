...
class GlyphData:
    ...
    CAT_DIACRITICS_OVERSHOOT = 'diacriticsOvershoot'
    ...
    CAT_OVERSHOOTS = (None, CAT_OVERSHOOT, CAT_CAP_OVERSHOOT, CAT_SUPERIOR_OVERSHOOT, CAT_SC_OVERSHOOT, CAT_ONUM_OVERSHOOT, CAT_DIACRITICS_OVERSHOOT)
