...
for GDS in (LATIN_L_SET, LATIN_L_SET_ITALIC):
    ...
    GDS['Glottalstop'] = GD(name='Glottalstop', uni=0x0241, hex='0241', c='Ɂ', l='C', r='O')
    ...
    GDS['glottalstop'] = GD(name='glottalstop', uni=0x0294, hex='0294', c='ʔ', l='C', r='O', isLower=True)
    ...
    GDS['Glottalstop.sc'] = GD(name='glottalstopsmall', uni=0x0242, hex='0242', c='ɂ', l='C', r='O', isSc=True)
