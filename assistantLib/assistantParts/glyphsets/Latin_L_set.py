...
GDS['Odieresismacron'] = GD(name='Odieresismacron', uni=0x022A, hex='022A', c='Ȫ', base='Odieresis', accents=['macroncmb.uc'], anchors=['bottom', 'middle', 'top'])
GDS['Odotaccent'] = GD(name='Odotaccent', uni=0x022E, hex='022E', c='Ȯ', base='O', accents=['dotaccentcmb.uc'], anchors=['bottom', 'middle', 'top'])
GDS['Odotaccentmacron'] = GD(name='Odotaccentmacron', uni=0x0230, hex='0230', c='Ȱ', base='Odotaccent', accents=['macroncmb.uc'], anchors=['bottom', 'middle', 'top'])
...
GDS['Omacronacute'] = GD(name='Omacronacute', uni=0x1E52, hex='1E52', c='Ṓ', l='O', r='O', base='Omacron', accents=['acutecmb.uc'], srcName='uni1E52', anchors=['bottom', 'middle', 'top'], gid=1005)
GDS['Omacrongrave'] = GD(name='Omacrongrave', uni=0x1E50, hex='1E50', c='Ṑ', l='O', r='O', base='Omacron', accents=['gravecmb.uc'], srcName='uni1E50', anchors=['bottom', 'middle', 'top'], gid=1003)
...
GDS['Otildeacute'] = GD(name='Otildeacute', uni=0x1E4C, hex='1E4C', c='Ṍ', l='O', r='O', base='Otilde', accents=['acutecmb.uc'], srcName='uni1E4C', anchors=['bottom', 'middle', 'top'], gid=999)
GDS['Otildedieresis'] = GD(name='Otildedieresis', uni=0x1E4E, hex='1E4E', c='Ṏ', l='O', r='O', base='Otilde', accents=['dieresiscmb.uc'], srcName='uni1E4E', anchors=['bottom', 'middle', 'top'], gid=1001)
GDS['Otildemacron'] = GD(name='Otildemacron', uni=0x022C, hex='022C', c='Ȭ', base='Otilde', accents=['macroncmb.uc'], anchors=['bottom', 'middle', 'top'])
...
GDS['shortequalsuperior'] = GD(name='shortequalsuperior', uni=0xA78A, srcName='equal', hex='A78A', c='꞊', l=MOD_MIN, r=MOD_MIN, isLower=True, isMod=True)
GDS['equalinferior'] = GD(name='equalinferior', uni=0x208C, hex='208C', c='₌', l=MOD_MIN, r=MOD_MIN, base='equalsuperior', isLower=True)
GDS['equalsuperior'] = GD(name='equalsuperior', uni=0x207C, hex='207C', c='⁼', l=MOD_MIN, r=MOD_MIN, srcName='shortequalsuperior', isLower=True)
...
GDS['udieresisbelow'] = GD(name='udieresisbelow', uni=0x1E73, hex='1E73', c='ṳ', l='u', r='u', base='u', accents=['dieresisbelow'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=1038)
