...
for GDS in (LATIN_L_SET, LATIN_L_SET_ITALIC):
    ...
    GDS['Oslashacute'] = GD(name='Oslashacute', uni=0x01FE, hex='01FE', c='Ǿ', l='O', r='O', srcName='O', accents=['acutecmb.uc'], anchors=['bottom', 'middle', 'ogonek', 'top'], comment='Ǿ')
    ...
    GDS['dcedilla'] = GD(name='dcedilla', uni=0x1E11, hex='1E11', c='ḑ', base='d', isLower=True, anchors=['bottom', 'middle', 'top'])
