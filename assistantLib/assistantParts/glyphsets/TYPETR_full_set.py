...
try:
    ...
    from glyphData import * #GD, TOP, TOP_, _BOTTOM, BOTTOM_, etc.
...
class TYPETR_GlyphSet(GlyphSet):
    ...
    GLYPH_DATA = {
        ...
        'acute': GD(l=CAT_CENTER, w=CAT_ACCENT_WIDTH, base='acutecmb', uni=0x00b4, c='´', name='acute', isLower=True, anchors=[], comment='´ spacing acute accent'),
        'approxequal': GD(g2='asciitilde', g1='asciitilde', l='equal', w=CAT_MATH_WIDTH, uni=0x2248, c='≈', name='approxequal', src='equal', comment='≈ EQUAL TO, ALMOST', anchors=[]),
        'approxequal.uc': GD(g2='asciitilde', g1='asciitilde', l='equal', w=CAT_MATH_WIDTH, name='approxequal.uc', base='approxequal', comment='≈ EQUAL TO, ALMOST, Uppercase', anchors=[]),
        'asciicircum': GD(uni=0x005e, l=CAT_CENTER, w=CAT_ACCENT_WIDTH, c='^', base='circumflexcmb', name='asciicircum', anchors=[], comment='^ spacing circumflex accent'),
        ...
        'ampersand': GD(l='a', uni=0x0026, c='&', name='ampersand', comment='& AMPERSAND', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT),
        ...
        'breve': GD(l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x02d8, c='˘', name='breve', base='brevecmb', comment='˘ Spacing Clones of Diacritics', anchors=[]),
        ...
        'caron': GD(l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x02c7, c='ˇ', name='caron', base='caroncmb', comment='ˇ tone, mandarin chinese third', anchors=[]),
        'cedilla': GD(l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x00b8, c='¸', name='cedilla', isLower=True, base='cedillacmb', comment='¸ spacing cedilla', anchors=[]),
        'cent': GD(g2='o', g1='c', l='c', r='c', uni=0x00a2, c='¢', base='c', name='cent', isLower=True, comment='¢ CENT SIGN'),
        'cent.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, name='cent.tab', base='cent', isLower=True, comment='¢ CENT SIGN TAB'),
        'circumflex': GD(l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x02c6, c='ˆ', name='circumflex', base='circumflexcmb', comment='ˆ CIRCUMFLEX ACCENT, MODIFIER LETTER', anchors=[]),
        ...
        'comma.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, name='comma.tab', base='comma', comment=', separator, decimal', anchors=[]),
        ...
        'dcaron': GD(g2='o', g1='dcaron', l='d', mr='comma', rightMin=CAT_MIN_RIGHT, uni=0x010f, c='ď', name='dcaron', isLower=True, base='d', accents=['caroncmb.vert'], comment='ď D WITH CARON, LATIN SMALL LETTER'),
        ...
        'dieresis': GD(l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x00a8, c='¨', name='dieresis', base='dieresiscmb', comment='¨ spacing diaeresis', anchors=[]),
        'divide': GD(l='plus', w=CAT_MATH_WIDTH, uni=0x00f7, c='÷', name='divide', comment='÷ obelus', anchors=[]),
        'divide.uc': GD(g2='divide', g1='divide', l='divide', w=CAT_MATH_WIDTH, name='divide.uc', comment='÷ obelus Uppercase', anchors=[]),
        'dollar': GD(g2='S', g1='S', l='S', r='S', uni=0x0024, c='$', base='S', name='dollar', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='$ milreis'),
        'dollar.alt1': GD(g2='S', g1='S', l='S', r='S', base='S', name='dollar.alt1', src='dollar', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='$ milreis'),
        'dollar.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, name='dollar.tab', src='dollar', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='$ milreis TAB'),
        'dollar.alt1.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, name='dollar.alt1.tab', src='dollar.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='$ milreis TAB'),
        'dotaccent': GD(l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x02d9, c='˙', name='dotaccent', base='dotaccentcmb', comment='˙ tone, mandarin chinese fifth or neutral', anchors=[]),
        ...
        'equal': GD(g2='hyphen', g1='hyphen', w=CAT_MATH_WIDTH, uni=0x003d, c='=', name='equal', comment='= EQUALS SIGN', anchors=[]),
        'equal.uc': GD(g2='hyphen', g1='hyphen', l='equal', w=CAT_MATH_WIDTH, name='equal.uc', comment='= EQUALS SIGN Uppercase', anchors=[]),
        ...
        'emdash': GD(g2='hyphen', g1='hyphen', l=CAT_CENTER, w=CAT_EM, uni=0x2014, c='—', name='emdash', comment='— EM DASH', anchors=[]),
        'emdash.uc': GD(g2='hyphen', g1='hyphen', l='emdash', r='emdash', name='emdash.uc', base='emdash', comment='— EM DASH Uppercase', anchors=[]),
        'endash': GD(g2='hyphen', g1='hyphen', l=CAT_CENTER, w=CAT_EM2, uni=0x2013, c='–', name='endash', comment='– EN DASH', anchors=[]),
        'endash.uc': GD(g2='hyphen', g1='hyphen', l='endash', r='endash', name='endash.uc', base='endash', comment='– EN DASH Uppercase', anchors=[]),
        'underscore': GD(l=CAT_CENTER, w=CAT_EM2, uni=0x005f, c='_', name='underscore', comment='_ underscore, spacing', anchors=[]),
        
        'f': GD(g2='f', g1='f', rightMin=CAT_MIN_RIGHT, fixAnchors=False, uni=0x0066, c='f', name='f', comment='f'),
        ...
        'grave': GD(l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x0060, c='`', name='grave', base='gravecmb', anchors=[], comment='` spacing grave accent'),
        'greater': GD(g2='greater', g1='greater', w=CAT_MATH_WIDTH, uni=0x003e, c='>', name='greater', comment='> GREATER-THAN SIGN', anchors=[]),
        'greater.uc': GD(g2='greater', g1='greater', l='greater', w=CAT_MATH_WIDTH, name='greater.uc', comment='> GREATER-THAN SIGN Uppercase', anchors=[]),
        'greaterequal': GD(g2='greater', g1='greater', l='greater', w=CAT_MATH_WIDTH, uni=0x2265, c='≥', name='greaterequal', comment='≥ GREATER-THAN OR EQUAL TO', anchors=[]),
        'greaterequal.uc': GD(g2='greaterequal', g1='greaterequal', l='greater', w=CAT_MATH_WIDTH, name='greaterequal.uc', comment='≥ GREATER-THAN OR EQUAL TO Uppercase', anchors=[]),
        ...
        'hungarumlaut': GD(g2='hungarumlaut', g1='hungarumlaut', l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x02dd, c='˝', name='hungarumlaut', base='hungarumlautcmb', comment='˝ DOUBLE ACUTE ACCENT', anchors=[]),
        ...
        'integral': GD(l=CAT_CENTER, w=CAT_TAB_WIDTH, uni=0x222b, c='∫', name='integral', src='f', anchors=[], comment='∫ Integral Signs'),
        ...
        'less': GD(g2='less', g1='less', w=CAT_MATH_WIDTH, uni=60, c='<', name='less', comment='< LESS-THAN SIGN', anchors=[]),
        'less.uc': GD(g2='less', g1='less', l='less', w=CAT_MATH_WIDTH, name='less.uc', comment='< LESS-THAN SIGN Uppercase', anchors=[]),
        'lessequal': GD(g2='less', g1='less', l='less', w=CAT_MATH_WIDTH, uni=0x2264, c='≤', name='lessequal', comment='≤ LESS-THAN OR EQUAL TO', anchors=[]),
        'lessequal.uc': GD(g2='lessequal', g1='lessequal', l='less', w=CAT_MATH_WIDTH, name='lessequal.uc', comment='≤ LESS-THAN OR EQUAL TO Uppercase', anchors=[]),
        'logicalnot': GD(g2='logicalnot', g1='logicalnot', l='equal', w=CAT_MATH_WIDTH, uni=0x00ac, c='¬', name='logicalnot', comment='¬ NOT SIGN', anchors=[]),
        'logicalnot.uc': GD(g2='logicalnot', g1='logicalnot', l='equal', w=CAT_MATH_WIDTH,  name='logicalnot.uc', comment='¬ NOT SIGN Uppercase', anchors=[]),
        ...
        'macron': GD(g2='macron', g1='macron', l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x00af, c='¯', name='macron', base='macroncmb', comment='¯ spacing macron', anchors=[]),
        'minus': GD(g2='hyphen', g1='hyphen', l='equal', w=CAT_MATH_WIDTH, uni=0x2212, c='−', name='minus', comment='− MINUS SIGN', anchors=[]),
        'minus.uc': GD(g2='hyphen', g1='hyphen', l='equal', w=CAT_MATH_WIDTH, name='minus.uc', comment='− MINUS SIGN Uppercase', anchors=[]),
        ...
        'multiply': GD(l=CAT_CENTER, w=CAT_MATH_WIDTH, uni=0x00d7, c='×', name='multiply', src='plus', comment='× product, cartesian', anchors=[]),
        'multiply.uc': GD(g2='multiply', g1='multiply', l='multiply', w=CAT_MATH_WIDTH, name='multiply.uc', comment='Multiply Uppercase', anchors=[]),
        ...
        'notequal': GD(g2='hyphen', g1='hyphen', l='equal', w=CAT_MATH_WIDTH, uni=0x2260, c='≠', name='notequal', base='equal', comment='≠ NOT EQUAL TO', anchors=[]),
        'notequal.uc': GD(g2='equal', g1='equal', l='equal', w=CAT_MATH_WIDTH, name='notequal.uc', comment='≠ NOT EQUAL TO Uppercase', anchors=[]),
        ...
        'ogonek': GD(g2='ogonek', g1='ogonek', l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x02db, c='˛', name='ogonek',isLower=True,  base='ogonekcmb', comment='˛ OGONEK', anchors=[]),
        ...
        'partialdiff': GD(l='o', r='o', uni=0x2202, c='∂', src='six', name='partialdiff', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='∂ PARTIAL DIFFERENTIAL'),
        'period': GD(g2='period', g1='period', l2r='period', uni=0x002e, c='.', name='period', anchors=[], comment='. point, decimal'),
        'period.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, name='period.tab', base='period', comment='. point, decimal', anchors=[]),
        ...
        'plus': GD(l='equal', w=CAT_MATH_WIDTH, uni=0x002b, c='+', name='plus', comment='+ PLUS SIGN', anchors=[]),
        'plus.uc': GD(g2='equal', g1='plus', l='plus', w=CAT_MATH_WIDTH, name='plus.uc', comment='+ PLUS SIGN Uppercase', anchors=[]),
        'plusminus': GD(l='equal', w=CAT_MATH_WIDTH, uni=0x00b1, c='±', name='plusminus', comment='± PLUS-MINUS SIGN', anchors=[]),
        'plusminus.uc': GD(g2='plusminus', g1='plusminus',l='equal', w=CAT_MATH_WIDTH, name='plusminus.uc', comment='± PLUS-MINUS SIGN Uppercase', anchors=[]),
        'product': GD(l='H', r='H', uni=0x220f, c='∏', src='H', name='product', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='∏ PRODUCT, N-ARY'),
        ...
        'ring': GD(g2='ring', g1='ring', l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x02da, c='˚', name='ring', base='ringcmb', comment='˚ RING ABOVE', anchors=[]),
        ...
        'space': GD(g1='space', g2='space', w=CAT_WORD_SPACE, uni=0x0020, c=' ', name='space', comment='  Symbols, ASCII Punctuation and', anchors=[]),
        'sterling': GD(l2r='sterling', uni=0x00a3, c='£', name='sterling', comment='£ sterling, pound', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT),
        'sterling.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, name='sterling.tab', src='sterling', comment='£ sterling, pound TAB', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT),
        'summation': GD(l='H', r='E', uni=0x2211, c='∑', name='summation', src='E', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='∑ SUMMATION, N-ARY'),
        ...
        'tilde': GD(g2='tilde', g1='tilde', l=CAT_CENTER, w=CAT_ACCENT_WIDTH, uni=0x02dc, c='˜', base='tildecmb', name='tilde', anchors=[]),
        ...
        'yen.tab': GD(l=CAT_CENTER, w=CAT_TAB_WIDTH, name='yen.tab', src='yen', comment='¥ yuan sign TAB'),
        ...
        'acutecmb': GD(g2='cmb', g1='cmb', w=0, uni=0x0301, c='́', name='acutecmb', anchors=[TOP]),
        ...
        'caroncmb.vert': GD(g2='cmb', g1='cmb', l='commabelowcmb', w=0, name='caroncmb.vert', src='commabelowcmb', anchors=[VERT]),
        ...
        'commabelowcmb': GD(g2='cmb', g1='cmb', l=CAT_CENTER, w=0, uni=0x0326, name='commabelowcmb', src='comma', anchors=[]),
        'commaturnedabovecmb': GD(g2='cmb', g1='cmb', l=CAT_CENTER,w=0, uni=0x0312, c='̒', src='commabelowcmb', name='commaturnedabovecmb', anchors=[TOP]),
        ...
        'dotmiddlecmb': GD(g2='cmb', g1='cmb', l=CAT_CENTER, w=0, src='dotaccentcmb', name='dotmiddlecmb', anchors=(MIDDLE,)),
        'gravecmb': GD(g2='cmb', g1='cmb', w=0, uni=0x0300, c='̀', name='gravecmb', anchors=[TOP]),
        ...
        'ringcmb': GD(g2='cmb', g1='cmb', w=0, l=CAT_CENTER, uni=0x030A, name='ringcmb', useSkewRotate=True, addItalicExtremePoints=True, anchors=[]),
        ...
        'commaturnedabovecmb.uc': GD(g2='cmb', g1='cmb', l=CAT_CENTER, w=0, name='commaturnedabovecmb.uc', src='commabelowcmb', anchors=[TOP]),
        ...
        'Euro.tab': GD(g2='Euro.tab', g1='Euro.tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, name='Euro.tab', src='Euro'), # Needs to be scaled
        'Euro.tab.sc': GD(g2='Euro.tab.sc', g1='Euro.tab.sc', l=CAT_CENTER, w=CAT_TAB_WIDTH, name='Euro.tab.sc', base='Euro.sc'),
        ...
        'bitcoin': GD(g2='B', g1='H', l='B', r='B', uni=0x20bf, c='₿', name='bitcoin', base='B', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT),
        'bitcoin.tab': GD(g2='bitcoin.tab', g1='bitcoin.tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, name='bitcoin.tab', src='bitcoin', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT),
        ...
        'onehalf': GD(g2='one.sups', g1='two.dnom', ml='one.sups', mr='two.sups', uni=0x00BD, c='½', name='onehalf', base='one.numr', accents=['fraction', 'two.dnom'], comment='½ VULGAR FRACTION ONE HALF', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'onequarter': GD(g2='one.sups', g1='four.dnom', ml='one.sups', mr='four.sups', uni=0x00BC, c='¼', name='onequarter', base='one.numr', accents=['fraction', 'four.dnom'], comment='¼ VULGAR FRACTION ONE QUARTER', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'threequarters': GD(g2='three.sups', g1='four.dnom', ml='three.sups', mr='four.sups', uni=0x00BE, c='¾', name='threequarters', base='three.numr', accents=['fraction', 'four.dnom'], comment='¾ VULGAR FRACTION THREE QUARTERS', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'percent': GD(g2='zero.sups', g1='zero.dnom', ml='zero.sups', mr='zero.sups', uni=0x0025, c='%', base='zero.numr', accents=['fraction', 'zero.dnom'], name='percent', comment='% PERCENT SIGN', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        ...
        'perthousand': GD(g2='zero.sups', g1='zero.dnom', ml='zero.sups', mr='zero.sups', uni=0x2030, c='‰', name='perthousand', base='zero.numr', accents=['fraction', 'zero.dnom', 'zero.dnom'], comment='‰ per thousand', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        ...
        'zero': GD(g2='zero', g1='zero', l2r='zero', uni=0x0030, c='0', name='zero', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='0 Digits, ASCII', useSkewRotate=True, addItalicExtremePoints=True),
        'zeroslash': GD(g2='zero', g1='zero', l='zero', w='zero', name='zeroslash', base='zero', src='slash', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='0 Digits, ASCII'),
        'one': GD(g2='one', g1='one', l2r='one', uni=0x0031, c='1', name='one', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='1'),
        'two': GD(g2='two', g1='two', l2r='two', uni=0x0032, c='2', name='two', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='2'),
        'two.alt1': GD(g2='two', g1='two', l='two', r='two', name='two.alt1', src='two', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='2 alternative'),
        'three': GD(g2='three', g1='three', l2r='three', uni=0x0033, c='3', name='three', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='3'),
        'four': GD(g2='four', g1='four', uni=0x0034, c='4', name='four', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='4'),
        'five': GD(g2='five', g1='five', l2r='five', uni=0x0035, c='5', name='five', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='5'),
        'five.alt1': GD(g2='five', g1='five', l='five', r='five', name='five.alt1', src='five', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='5 alternative'),
        'six': GD(g2='six', g1='six',  l2r='six', uni=0x0036, c='6', name='six', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='6'),
        'seven': GD(g2='seven', g1='seven', uni=0x0037, c='7', name='seven', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='7'),
        'seven.alt1': GD(g2='seven', g1='seven', l='seven', r='seven', name='seven.alt1', src='seven', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='7 alternative'),
        'eight': GD(g2='eight', g1='eight', l2r='eight', uni=0x0038, c='8', name='eight', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='8'),
        'nine': GD(g2='nine', g1='nine', l2r='six', r2l='six', uni=0x0039, c='9', name='nine', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='9'),
        ...
        'zero.sc': GD(l='o', r='o', src='o', name='zero.sc', comment='0 Digits, ASCII Smallcaps', useSkewRotate=True, addItalicExtremePoints=True, 
            height=CAT_SC_HEIGHT, overshoot=CAT_SC_OVERSHOOT),
        ...
        'zero.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, src='zero', name='zero.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='0 Digits, ASCII TAB', useSkewRotate=True, addItalicExtremePoints=True), # Make as outline, because Black needs to be condensed.
        'zeroslash.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, base='zero.tab', src='slash', name='zeroslash.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='0 Digits, ASCII TAB slash'), 
        'one.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, base='one', name='one.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='1 TAB'),
        'two.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, base='two', name='two.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='2 TAB'),
        'three.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, base='three', name='three.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='3 TAB'),
        'four.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, src='four', name='four.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='4 TAB'),
        'five.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, base='five', name='five.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='5 TAB'),
        'six.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, src='six', name='six.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='6 TAB'),
        'seven.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, base='seven', name='seven.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='7 TAB'),
        'eight.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, src='eight', name='eight.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='8 TAB'),
        'nine.tab': GD(g2='tab', g1='tab', l=CAT_CENTER, w=CAT_TAB_WIDTH, src='nine', name='nine.tab', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT, comment='9 TAB'),

        'zero.sups': GD(g2='zero.sups', g1='zero.sups', l2r='zero.sups', uni=0x2070, c='⁰', name='zero.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT, useSkewRotate=True, addItalicExtremePoints=True),
        'onesuperior': GD(g2='one.sups', g1='one.sups', l='one.sups', r='one.sups', uni=0x00b9, c='¹', name='onesuperior', base='one.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'one.sups': GD(g2='one.sups', g1='one.sups', l2r='one.sups', name='one.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'twosuperior': GD(g2='two.sups', g1='two.sups', l='two.sups', r='two.sups', uni=0x00b2, c='²', name='twosuperior', base='two.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'two.sups': GD(g2='two.sups', g1='two.sups', l2r='two.sups', name='two.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'threesuperior': GD(g2='sups', g1='sups', l='three.sups', r='three.sups', uni=0x00b3, c='³', name='threesuperior', base='three.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'three.sups': GD(g2='sups', g1='sups', l2r='three.sups', name='three.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT, addItalicExtremePoints=True),
        'four.sups': GD(g2='four.sups', g1='four.sups', uni=0x2074, c='⁴', name='four.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'five.sups': GD(g2='sups', g1='sups', l2r='five.sups', uni=0x2075, c='⁵', name='five.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'six.sups': GD(g2='sups', g1='sups', l2r='six.sups', uni=0x2076, c='⁶', name='six.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT, addItalicExtremePoints=True),
        'seven.sups': GD(g2='seven.sups', g1='seven.sups', l2r='seven.sups', uni=0x2077, c='⁷', name='seven.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'eight.sups': GD(g2='sups', g1='sups', l2r='eight.sups', uni=0x2078, c='⁸', name='eight.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT, addItalicExtremePoints=True),
        'nine.sups': GD(g2='sups', g1='sups', l2r='six.sups', r2l='six.sups', uni=0x2079, c='⁹', name='nine.sups', baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT, addItalicExtremePoints=True),
        'period.sups': GD(g2='period.sups', g1='period.sups', l='period', r='period', name='period.sups', src='dotaccentcmb', anchors=[], baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'comma.sups': GD(g2='period.sups', g1='period.sups', l='comma', r='comma', name='comma.sups', src='comma', anchors=[], baseline=CAT_SUPS_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),

        'zero.dnom': GD(g2='zero.dnom', g1='zero.dnom', l='zero.sups', w='zero.sups', name='zero.dnom', base='zero.sups', baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'one.dnom': GD(g2='one.dnom', g1='one.dnom', l='one.sups', w='one.sups', name='one.dnom', base='one.sups', baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'two.dnom': GD(g2='two.dnom', g1='two.dnom', l='two.sups', w='two.sups', name='two.dnom', base='two.sups', baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'three.dnom': GD(g2='dnom', g1='dnom', l='three.sups', w='three.sups', name='three.dnom', base='three.sups', baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'four.dnom': GD(g2='four.dnom', g1='four.dnom', l='four.sups', w='four.sups', name='four.dnom', base='four.sups', baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'five.dnom': GD(g2='dnom', g1='dnom', l='five.sups', w='five.sups', name='five.dnom', base='five.sups', baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'six.dnom': GD(g2='dnom', g1='dnom', l='six.sups', w='six.sups', name='six.dnom', base='six.sups', baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'seven.dnom': GD(g2='seven.dnom', g1='seven.dnom', l='seven.sups', w='seven.sups', name='seven.dnom', base='seven.sups', baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'eight.dnom': GD(g2='dnom', g1='dnom', l='eight.sups', w='eight.sups', name='eight.dnom', base='eight.sups', baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'nine.dnom': GD(g2='dnom', g1='dnom', l='nine.sups', w='nine.sups', name='nine.dnom', base='nine.sups', baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'period.dnom': GD(g2='period.dnom', g1='period.dnom', l='period', r='period', name='period.dnom', base='period.sups', anchors=[], baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'comma.dnom': GD(g2='period.dnom', g1='period.dnom', l='comma', r='comma', name='comma.dnom', base='comma.sups', anchors=[], baseline=CAT_DNOM_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),

        'zero.numr': GD(g2='zero.numr', g1='zero.numr', l='zero.sups', w='zero.sups', name='zero.numr', base='zero.sups', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'one.numr': GD(g2='one.numr', g1='one.numr', l='one.sups', w='one.sups', name='one.numr', base='one.sups', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'two.numr': GD(g2='two.numr', g1='two.numr', l='two.sups', w='two.sups', name='two.numr', base='two.sups', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'three.numr': GD(g2='numr', g1='numr', l='three.sups', w='three.sups', name='three.numr', base='three.sups', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'four.numr': GD(g2='four.numr', g1='four.numr', l='four.sups', w='four.sups', name='four.numr', base='four.sups', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'five.numr': GD(g2='numr', g1='numr', l='five.sups', w='five.sups', name='five.numr', base='five.sups', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'six.numr': GD(g2='numr', g1='numr', l='six.sups', w='six.sups', name='six.numr', base='six.sups', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'seven.numr': GD(g2='seven.numr', g1='seven.numr', l='seven.sups', w='seven.sups', name='seven.numr', base='seven.sups', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'eight.numr': GD(g2='numr', g1='numr', l='eight.sups', w='eight.sups', name='eight.numr', base='eight.sups', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'nine.numr': GD(g2='numr', g1='numr', l='nine.sups', w='nine.sups', name='nine.numr', base='nine.sups', baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'period.numr': GD(g2='period.numr', g1='period.numr', l='period', r='period', name='period.numr', base='period.sups', anchors=[], baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'comma.numr': GD(g2='period.numr', g1='period.numr', l='comma', r='comma', name='comma.numr', base='comma.sups', anchors=[], baseline=CAT_NUMR_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),

        'zero.sinf': GD(g2='zero.sinf', g1='zero.sinf', l='zero.sups', w='zero.sups', uni=0x2080, c='₀', name='zero.sinf', base='zero.sups', baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'one.sinf': GD(g2='one.sinf', g1='one.sinf', l='one.sups', w='one.sups', uni=0x2081, c='₁', name='one.sinf', base='one.sups', baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'two.sinf': GD(g2='two.sinf', g1='two.sinf', l='two.sups', w='two.sups', uni=0x2082, c='₂', name='two.sinf', base='two.sups', baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'three.sinf': GD(g2='sinf', g1='sinf', l='three.sups', w='three.sups', uni=0x2083, c='₃', name='three.sinf', base='three.sups', baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'four.sinf': GD(g2='four.sinf', g1='four.sinf', l='four.sups', w='four.sups', uni=0x2084, c='₄', name='four.sinf', base='four.sups', baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'five.sinf': GD(g2='sinf', g1='sinf', l='five.sups', w='five.sups', uni=0x2085, c='₅', name='five.sinf', base='five.sups', baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'six.sinf': GD(g2='sinf', g1='sinf', l='six.sups', w='six.sups', uni=0x2086, c='₆', name='six.sinf', base='six.sups', baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'seven.sinf': GD(g2='seven.sinf', g1='seven.sinf', l='seven.sups', w='seven.sups', uni=0x2087, c='₇', name='seven.sinf', base='seven.sups', baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'eight.sinf': GD(g2='sinf', g1='sinf', l='eight.sups', w='eight.sups', uni=0x2088, c='₈', name='eight.sinf', base='eight.sups', baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'nine.sinf': GD(g2='sinf', g1='sinf', l='nine.sups', w='nine.sups', uni=0x2089, c='₉', name='nine.sinf', base='nine.sups', baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'period.sinf': GD(g2='period.sinf', g1='period.sinf', l='period', r='period', name='period.numr', base='period.sups', anchors=[], baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
        'comma.sinf': GD(g2='period.sinf', g1='period.sinf', l='comma', r='comma', name='comma.numr', base='comma.sups', anchors=[], baseline=CAT_SINF_BASELINE, height=CAT_SUPS_HEIGHT, overshoot=CAT_SUPS_OVERSHOOT),
...
gids['f'] = GD(g2='f', g1='f', rightMin=CAT_MIN_RIGHT, fixAnchors=False, uni=0x0066, c='f', name='f', comment='f')
...
gids['ampersand'] = GD(g2='ampersand', g1='ampersand', r2l='three', uni=0x0026, c='&', name='ampersand', comment='& AMPERSAND', height=CAT_CAP_HEIGHT, overshoot=CAT_CAP_OVERSHOOT)
