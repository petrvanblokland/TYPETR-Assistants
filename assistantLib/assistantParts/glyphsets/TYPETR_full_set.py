...
class TYPETR_GlyphSet(GlyphSet):
    ...
    GLYPH_DATA = {
        ...
        'J': GD(g2='J', g1='J', l='off', w='I', uni=74, c='J', name='J', hex='004a', comment='J'), # Manually take margins from /I
        ...
        'Z': GD(g2='Z', g1='Z', l2r='Z', uni=0x005a, c='Z', name='Z', comment='Z'),
        ...
        'ae': GD(g2='a', g1='e', l='a', r='e', uni=0x00e6, c='æ', name='ae', isLower=True, comment='æ small ligature ae, latin'),
        'aeacute': GD(g2='a', g1='o', l='a', r='e', uni=0x01fd, c='ǽ', name='aeacute', base='ae', isLower=True, accents=['acutecmb'], comment='ǽ'),
        ...
        'dcaron': GD(g2='o', g1='dcaron', l='d', r='comma', uni=0x010f, c='ď', name='dcaron', isLower=True, base='d', accents=['caroncmb.vert'], comment='ď D WITH CARON, LATIN SMALL LETTER'),
        ...
        'germandbls': GD(g2='germandbls', g1='germandbls', l='l', r='s', uni=0x00df, c='ß', name='germandbls', isLower=True, comment='ß SHARP S, LATIN SMALL LETTER'),
        'Germandbls': GD(g2='germandbls', g1='germandbls', l='H', r='S', uni=0x1E9E, c='ẞ', name='Germandbls', src='germandbls', isLower=False, comment='ẞ Latin Capital Letter Sharp S'),
        'Germandbls.sc': GD(g2='germandbls', g1='germandbls', l='H.sc', r='S.sc', name='Germandbls.sc', src='Germandbls', isLower=False, comment='ẞ Small caps Latin Capital Letter Sharp S'),
        ...
        'i': GD(g2='i', g1='i', l='idotless', w='idotless', uni=0x0069, c='i', name='i', isLower=True, comment='i'),
        'i.trk': GD(g2='i', g1='i', l='n', r='n', name='i.trk', isLower=True, comment='i.trk', base='idotless', accents=['dotaccentcmb']),
        'iacute': GD(g2='i', g1='i', bl='idotless', w='i', uni=0x00ed, c='í', isLower=True, name='iacute', base='idotless', accents=['acutecmb'], comment='í I WITH ACUTE, LATIN SMALL LETTER'),
        'ibreve': GD(g2='i', g1='i', bl='idotless', w='i', uni=0x012d, c='ĭ', isLower=True, name='ibreve', base='idotless', accents=['brevecmb'], comment='ĭ I WITH BREVE, LATIN SMALL LETTER'),
        'icircumflex': GD(g2='i', g1='i', bl='idotless', w='i', uni=0x00ee, c='î', isLower=True, name='icircumflex', base='idotless', accents=['circumflexcmb'], comment='î I WITH CIRCUMFLEX, LATIN SMALL LETTER'),
        'idieresis': GD(g2='i', g1='i', bl='idotless', w='i', uni=0x00ef, c='ï', isLower=True, name='idieresis', base='idotless', accents=['dieresiscmb'], comment='ï I WITH DIAERESIS, LATIN SMALL LETTER'),
        'igrave': GD(g2='i', g1='i', bl='idotless', w='i', uni=0x00ec, c='ì', name='igrave', isLower=True, base='idotless', accents=['gravecmb'], comment='ì I WITH GRAVE, LATIN SMALL LETTER'),
        'imacron': GD(g2='i', g1='i', bl='idotless', w='i', uni=0x012b, c='ī', name='imacron', isLower=True, base='idotless', accents=['macroncmb'], comment='ī I WITH MACRON, LATIN SMALL LETTER'),
        'iogonek': GD(g2='i', g1='i', bl='idotless', w='i', uni=0x012f, c='į', name='iogonek', isLower=True, base='i', accents=['ogonekcmb'], comment='į I WITH OGONEK, LATIN SMALL LETTER'),
        'itilde': GD(g2='i', g1='i', bl='idotless', w='i', uni=0x0129, c='ĩ', name='itilde', isLower=True, base='idotless', accents=['tildecmb'], comment='ĩ I WITH TILDE, LATIN SMALL LETTER'),
        ...
        'pi': GD(uni=0x03c0, c='π', name='pi', isLower=True, src='t', anchors=[]),
        ...
        'r': GD(g2='n', g1='r', l='n', r='off', uni=0x0072, c='r', name='r', isLower=True, comment='r'),
        ...
        'onehalf': GD(g2='one.sups', g1='two.dnom', bl='one.sups', br='two.sups', uni=0x00BD, c='½', name='onehalf', base='one.numr', accents=['fraction', 'two.dnom'], comment='½ VULGAR FRACTION ONE HALF', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'onequarter': GD(g2='one.sups', g1='four.dnom', bl='one.sups', br='four.sups', uni=0x00BC, c='¼', name='onequarter', base='one.numr', accents=['fraction', 'four.dnom'], comment='¼ VULGAR FRACTION ONE QUARTER', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'threequarters': GD(g2='three.sups', g1='four.dnom', bl='three.sups', br='four.sups', uni=0x00BE, c='¾', name='threequarters', base='three.numr', accents=['fraction', 'four.dnom'], comment='¾ VULGAR FRACTION THREE QUARTERS', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'percent': GD(g2='zero.sups', g1='zero.dnom', bl='zero.sups', br='zero.sups', uni=0x0025, c='%', base='zero.numr', accents=['fraction', 'zero.dnom'], name='percent', comment='% PERCENT SIGN', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        ...
        'perthousand': GD(g2='zero.sups', g1='zero.dnom', bl='zero.sups', br='zero.sups', uni=0x2030, c='‰', name='perthousand', base='zero.numr', accents=['fraction', 'zero.dnom', 'zero.dnom'], comment='‰ per thousand', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        ...
        'one': GD(g2='one', g1='one', l='off', r='H', uni=0x0031, c='1', name='one', height=GD.CAT_CAP_HEIGHT, overshoot=GD.CAT_CAP_OVERSHOOT, comment='1'),
        ...
        'five': GD(g2='five', g1='five', l='off', r='off', uni=0x0035, c='5', name='five', height=GD.CAT_CAP_HEIGHT, overshoot=GD.CAT_CAP_OVERSHOOT, comment='5'),
        ...
        'five.onum': GD(g2='five.onum', g1='five.onum', l='five', w='fivjfivee', name='five.onum', base='five', comment='5 Old style'),
        ...
        'zero.sups': GD(g2='zero.sups', g1='zero.sups', l2r='zero.sups', uni=0x2070, c='⁰', name='zero.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT, useSkewRotate=True, addItalicExtremePoints=True),
        'onesuperior': GD(g2='one.sups', g1='one.sups', l='one.sups', r='one.sups', uni=0x00b9, c='¹', name='onesuperior', base='one.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'one.sups': GD(g2='one.sups', g1='one.sups', l2r='one.sups', name='one.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'twosuperior': GD(g2='two.sups', g1='two.sups', l='two.sups', r='two.sups', uni=0x00b2, c='²', name='twosuperior', base='two.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'two.sups': GD(g2='two.sups', g1='two.sups', l2r='two.sups', name='two.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'threesuperior': GD(g2='sups', g1='sups', l='three.sups', r='three.sups', uni=0x00b3, c='³', name='threesuperior', base='three.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'three.sups': GD(g2='sups', g1='sups', l2r='three.sups', name='three.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT, addItalicExtremePoints=True),
        'four.sups': GD(g2='four.sups', g1='four.sups', uni=0x2074, c='⁴', name='four.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'five.sups': GD(g2='sups', g1='sups', l2r='five.sups', uni=0x2075, c='⁵', name='five.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'six.sups': GD(g2='sups', g1='sups', l2r='six.sups', uni=0x2076, c='⁶', name='six.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT, addItalicExtremePoints=True),
        'seven.sups': GD(g2='seven.sups', g1='seven.sups', l2r='seven.sups', uni=0x2077, c='⁷', name='seven.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'eight.sups': GD(g2='sups', g1='sups', l2r='eight.sups', uni=0x2078, c='⁸', name='eight.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT, addItalicExtremePoints=True),
        'nine.sups': GD(g2='sups', g1='sups', l2r='six.sups', r2l='six.sups', uni=0x2079, c='⁹', name='nine.sups', baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT, addItalicExtremePoints=True),
        'period.sups': GD(g2='period.sups', g1='period.sups', l='period', r='period', name='period.sups', src='dotaccentcmb', anchors=[], baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'comma.sups': GD(g2='period.sups', g1='period.sups', l='comma', r='comma', name='comma.sups', src='comma', anchors=[], baseline=GD.CAT_SUPS_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),

        'zero.dnom': GD(g2='zero.dnom', g1='zero.dnom', l='zero.sups', w='zero.sups', name='zero.dnom', base='zero.sups', baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'one.dnom': GD(g2='one.dnom', g1='one.dnom', l='one.sups', w='one.sups', name='one.dnom', base='one.sups', baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'two.dnom': GD(g2='two.dnom', g1='two.dnom', l='two.sups', w='two.sups', name='two.dnom', base='two.sups', baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'three.dnom': GD(g2='dnom', g1='dnom', l='three.sups', w='three.sups', name='three.dnom', base='three.sups', baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'four.dnom': GD(g2='four.dnom', g1='four.dnom', l='four.sups', w='four.sups', name='four.dnom', base='four.sups', baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'five.dnom': GD(g2='dnom', g1='dnom', l='five.sups', w='five.sups', name='five.dnom', base='five.sups', baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'six.dnom': GD(g2='dnom', g1='dnom', l='six.sups', w='six.sups', name='six.dnom', base='six.sups', baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'seven.dnom': GD(g2='seven.dnom', g1='seven.dnom', l='seven.sups', w='seven.sups', name='seven.dnom', base='seven.sups', baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'eight.dnom': GD(g2='dnom', g1='dnom', l='eight.sups', w='eight.sups', name='eight.dnom', base='eight.sups', baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'nine.dnom': GD(g2='dnom', g1='dnom', l='nine.sups', w='nine.sups', name='nine.dnom', base='nine.sups', baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'period.dnom': GD(g2='period.dnom', g1='period.dnom', l='period', r='period', name='period.dnom', base='period.sups', anchors=[], baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'comma.dnom': GD(g2='period.dnom', g1='period.dnom', l='comma', r='comma', name='comma.dnom', base='comma.sups', anchors=[], baseline=GD.CAT_DNOM_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),

        'zero.numr': GD(g2='zero.numr', g1='zero.numr', l='zero.sups', w='zero.sups', name='zero.numr', base='zero.sups', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'one.numr': GD(g2='one.numr', g1='one.numr', l='one.sups', w='one.sups', name='one.numr', base='one.sups', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'two.numr': GD(g2='two.numr', g1='two.numr', l='two.sups', w='two.sups', name='two.numr', base='two.sups', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'three.numr': GD(g2='numr', g1='numr', l='three.sups', w='three.sups', name='three.numr', base='three.sups', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'four.numr': GD(g2='four.numr', g1='four.numr', l='four.sups', w='four.sups', name='four.numr', base='four.sups', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'five.numr': GD(g2='numr', g1='numr', l='five.sups', w='five.sups', name='five.numr', base='five.sups', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'six.numr': GD(g2='numr', g1='numr', l='six.sups', w='six.sups', name='six.numr', base='six.sups', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'seven.numr': GD(g2='seven.numr', g1='seven.numr', l='seven.sups', w='seven.sups', name='seven.numr', base='seven.sups', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'eight.numr': GD(g2='numr', g1='numr', l='eight.sups', w='eight.sups', name='eight.numr', base='eight.sups', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'nine.numr': GD(g2='numr', g1='numr', l='nine.sups', w='nine.sups', name='nine.numr', base='nine.sups', baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'period.numr': GD(g2='period.numr', g1='period.numr', l='period', r='period', name='period.numr', base='period.sups', anchors=[], baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'comma.numr': GD(g2='period.numr', g1='period.numr', l='comma', r='comma', name='comma.numr', base='comma.sups', anchors=[], baseline=GD.CAT_NUMR_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),

        'zero.sinf': GD(g2='zero.sinf', g1='zero.sinf', l='zero.sups', w='zero.sups', uni=0x2080, c='₀', name='zero.sinf', base='zero.sups', baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'one.sinf': GD(g2='one.sinf', g1='one.sinf', l='one.sups', w='one.sups', uni=0x2081, c='₁', name='one.sinf', base='one.sups', baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'two.sinf': GD(g2='two.sinf', g1='two.sinf', l='two.sups', w='two.sups', uni=0x2082, c='₂', name='two.sinf', base='two.sups', baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'three.sinf': GD(g2='sinf', g1='sinf', l='three.sups', w='three.sups', uni=0x2083, c='₃', name='three.sinf', base='three.sups', baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'four.sinf': GD(g2='four.sinf', g1='four.sinf', l='four.sups', w='four.sups', uni=0x2084, c='₄', name='four.sinf', base='four.sups', baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'five.sinf': GD(g2='sinf', g1='sinf', l='five.sups', w='five.sups', uni=0x2085, c='₅', name='five.sinf', base='five.sups', baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'six.sinf': GD(g2='sinf', g1='sinf', l='six.sups', w='six.sups', uni=0x2086, c='₆', name='six.sinf', base='six.sups', baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'seven.sinf': GD(g2='seven.sinf', g1='seven.sinf', l='seven.sups', w='seven.sups', uni=0x2087, c='₇', name='seven.sinf', base='seven.sups', baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'eight.sinf': GD(g2='sinf', g1='sinf', l='eight.sups', w='eight.sups', uni=0x2088, c='₈', name='eight.sinf', base='eight.sups', baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'nine.sinf': GD(g2='sinf', g1='sinf', l='nine.sups', w='nine.sups', uni=0x2089, c='₉', name='nine.sinf', base='nine.sups', baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'period.sinf': GD(g2='period.sinf', g1='period.sinf', l='period', r='period', name='period.numr', base='period.sups', anchors=[], baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
        'comma.sinf': GD(g2='period.sinf', g1='period.sinf', l='comma', r='comma', name='comma.numr', base='comma.sups', anchors=[], baseline=GD.CAT_SINF_BASELINE, height=GD.CAT_SUPERIOR_HEIGHT, overshoot=GD.CAT_SUPERIOR_OVERSHOOT),
