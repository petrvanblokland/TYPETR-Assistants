...
LATIN_S_SET = GDS = {
    ...
    'endash.uc': GD(name='endash.uc', isLower=False, l='endash', w='endash', base='endash', comment='– EN DASH'),
    'emdash': GD(g2='hyphen', g1='hyphen', l=GD.CAT_CENTER, w=GD.CAT_EM_WIDTH, uni=0x2014, c='—', name='emdash', comment='— EM DASH', anchors=[]),
    'emdash.uc': GD(g2='hyphen', g1='hyphen', l='emdash', w='emdash', name='emdash.uc', base='emdash', isLower=False, comment='— EM DASH Uppercase', anchors=[]),
...
SC_NAMES = (
    ...
    # c2sc OT-features
    'Alpha', 'Alphatonos', 'Archaicsampi', 'Beta', 'Chi', 'Dei_coptic', 'Delta', 'Digamma', 'Epsilon', 'Epsilontonos', 'Eta', 'Etatonos', 'Fei_coptic', 
    'Gamma', 'Gangia_coptic', 'Heta', 'Hori_coptic', 'Iota', 'Iotadieresis', 'Iotatonos', 'KaiSymbol', 'Kappa', 'Khei_coptic', 'Koppa', 'KoppaArchaic', 
    'Lambda', 'Mu', 'Nu', 'Omega', 'Omegatonos', 'Omicron', 'Omicrontonos', 'Pamphyliandigamma', 'Phi', 'Pi', 'Psi', 'Rho', 'Sampi', 'San', 'Shei_coptic', 
    'Shima_coptic', 'Sho', 'Sigma', 'SigmaLunateDottedReversedSymbol', 'SigmaLunateDottedSymbol', 'SigmaLunateReversedSymbol', 'SigmaLunateSymbol', 
