...
LATIN_S_SET = GDS = {
    ...
    'dollar': GD(name='dollar', uni=0x0024, hex='0024', c='$', w='zero.tnum', isLower=False, gid=6, comment='$ milreis'),
    'dollar.alt': GD(name='dollar.alt', w='zero.tnum', src='dollar', isLower=False, gid=6, comment='$ milreis'),
    ...
    'macron': GD(name='macron', uni=0x00AF, hex='00AF', c='¯', l=CENTER, w=ACCENT_WIDTH, base='macroncomb', srcName='uni00AF', isLower=True, gid=112, comment='¯ spacing macron'),
    ...
    'quoteleft': GD(name='quoteleft', uni=0x2018, hex='2018', c='‘', l='quotesingle', r='quotesingle', base='quoteleftcmb', isLower=True, gid=1411, comment='‘ turned comma quotation mark, single'),
    'quoteright': GD(name='quoteright', uni=0x2019, hex='2019', c='’', l='quotesingle', r='quotesingle', base='quoterightcmb', comment='’ SINGLE QUOTATION MARK, RIGHT'),
    ...
    'twosuperior': GD(name='twosuperior', uni=0x00B2, hex='00B2', c='²', l='two.numr', r='two.numr', base='two.numr', isLower=False, gid=115, comment='² TWO, SUPERSCRIPT'),
    'threesuperior': GD(name='threesuperior', uni=0x00B3, hex='00B3', c='³', l='three.numr', r='three.numr', base='three.numr', isLower=False, gid=116, comment='³ THREE, SUPERSCRIPT'),
    ...
    'aacute': GD(name='aacute', uni=0x00E1, hex='00E1', c='á', w='a', bl='a', base='a', accents=['acutecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=162, comment='á A WITH ACUTE, LATIN SMALL LETTER'),
    'abreve': GD(name='abreve', uni=0x0103, hex='0103', c='ă', w='a', bl='a', base='a', accents=['brevecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=196, comment='ă A WITH BREVE, LATIN SMALL LETTER'),
    'acaron': GD(name='acaron', uni=0x01CE, hex='01CE', c='ǎ', w='a', bl='a', base='a', accents=['caroncmb'], srcName='uni01CE', isLower=True, anchors=['bottom', 'middle', 'top'], gid=399),
    'acircumflex': GD(name='acircumflex', uni=0x00E2, hex='00E2', c='â', w='a', bl='a', base='a', accents=['circumflexcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=163, comment='â A WITH CIRCUMFLEX, LATIN SMALL LETTER'),
    'adieresis': GD(name='adieresis', uni=0x00E4, hex='00E4', c='ä', w='a', bl='a', base='a', accents=['dieresiscmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=165, comment='ä A WITH DIAERESIS, LATIN SMALL LETTER'),
    ...
    'agrave': GD(name='agrave', uni=0x00E0, hex='00E0', c='à', w='a', bl='a', base='a', accents=['gravecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=161, comment='à A WITH GRAVE, LATIN SMALL LETTER'),
    ...
    'aring': GD(name='aring', uni=0x00E5, hex='00E5', c='å', base='a', accents=['ringcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=166, comment='å RING ABOVE, LATIN SMALL LETTER A WITH'),
    'atilde': GD(name='atilde', uni=0x00E3, hex='00E3', c='ã', base='a', accents=['tildecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=164, comment='ã A WITH TILDE, LATIN SMALL LETTER'),
    ...
    'brevecmb': GD(name='brevecmb', uni=0x0306, hex='0306', c='̆', w='0', srcName='uni0306', isLower=True, anchors=['_top', 'top']),
    'brevecmb.uc': GD(name='brevecmb.uc', w='0', src='brevecmb', isLower=True, anchors=['_top', 'top']),

    # c

    'c': GD(name='c', uni=0x0063, hex='0063', c='c', isLower=True, anchors=['bottom', 'dot', 'middle', 'top'], gid=69, comment='c'),
    'cacute': GD(name='cacute', uni=0x0107, hex='0107', c='ć', base='c', accents=['acutecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=200, comment='ć C WITH ACUTE, LATIN SMALL LETTER'),
    'ccaron': GD(name='ccaron', uni=0x010D, hex='010D', c='č', base='c', accents=['caroncmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=206, comment='č C WITH CARON, LATIN SMALL LETTER'),
    ...
    'ccircumflex': GD(name='ccircumflex', uni=0x0109, hex='0109', c='ĉ', base='c', accents=['circumflexcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=202, comment='ĉ C WITH CIRCUMFLEX, LATIN SMALL LETTER'),
    'cdotaccent': GD(name='cdotaccent', uni=0x010B, hex='010B', c='ċ', base='c', accents=['dotaccentcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=204),
    ...
    'caroncmb': GD(name='caroncmb', uni=0x030C, hex='030C', c='̌', w='0', isLower=True, anchors=['_top', 'top']),
    'caroncmb.uc': GD(name='caroncmb.uc', w='0', src='caroncmb', isLower=True, anchors=['_top', 'top']),
    'commaaccentcmb': GD(name='commaaccentcmb', uni=0x0326, hex='0326', c='̦', w='0', isLower=True, anchors=['_bottom', 'bottom']),
    'commaaccentcmb.uc': GD(name='commaaccentcmb.uc', w='0', src='commaaccentcmb', isLower=True, anchors=['_bottom', 'bottom']),
    'commaturnedabovecmb': GD(name='commaturnedabovecmb', uni=0x0312, hex='0312', c='̒', w='0', isLower=True, anchors=['_top', 'top']),
    'commaturnedabovecmb.uc': GD(name='commaturnedabovecmb.uc', w='0', src='commaturnedabovecmb', isLower=True, anchors=['_top', 'top']),
    'circumflexcmb': GD(name='circumflexcmb', uni=0x0302, hex='0302', c='̂', w='0', base='circumflexcmb', isLower=True, anchors=['_top', 'top']),
    'circumflexcmb.uc': GD(name='circumflexcmb.uc', w='0', src='circumflexcmb', isLower=True, anchors=['_top', 'top']),
    ...
    'dieresiscmb.uc': GD(name='dieresiscmb.uc', w='0', src='dieresiscmb', isLower=True, anchors=['_top', 'top']),
    'dotaccentcmb': GD(name='dotaccentcmb', uni=0x0307, hex='0307', c='̇', w='0', isLower=True, anchors=['_top', 'top']),
    'dotaccentcmb.uc': GD(name='dotaccentcmb.uc', w='0', src='dotaccentcmb', isLower=True, anchors=['_top', 'top']),
    'dotbelowcmb': GD(name='dotbelowcmb', uni=0x0323, hex='0323', c='̣', w='0', isLower=True, anchors=['_bottom', 'bottom']),
    'dotbelowcmb.uc': GD(name='dotbelowcmb.uc', w='0', src='dotbelowcmb', isLower=True, anchors=['_bottom', 'bottom']),

    # e

    'e': GD(name='e', uni=0x0065, hex='0065', c='e', isLower=True, anchors=['bottom', 'middle', 'ogonek', 'top'], gid=71, comment='e'),
    'eacute': GD(name='eacute', uni=0x00E9, hex='00E9', c='é', base='e', accents=['acutecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=170, comment='é E WITH ACUTE, LATIN SMALL LETTER'),
    'ebreve': GD(name='ebreve', uni=0x0115, hex='0115', c='ĕ', base='e', accents=['brevecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=214, comment='ĕ E WITH BREVE, LATIN SMALL LETTER'),
    'ecaron': GD(name='ecaron', uni=0x011B, hex='011B', c='ě', base='e', accents=['caroncmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=220, comment='ě E WITH CARON, LATIN SMALL LETTER'),
    'ecircumflex': GD(name='ecircumflex', uni=0x00EA, hex='00EA', c='ê', base='e', accents=['circumflexcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=171, comment='ê E WITH CIRCUMFLEX, LATIN SMALL LETTER'),
    'edieresis': GD(name='edieresis', uni=0x00EB, hex='00EB', c='ë', w='e', base='e', accents=['dieresiscmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=172, comment='ë E WITH DIAERESIS, LATIN SMALL LETTER'),
    'edotaccent': GD(name='edotaccent', uni=0x0117, hex='0117', c='ė', w='e', base='e', accents=['dotaccentcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=216),
    'edotbelow': GD(name='edotbelow', uni=0x1EB9, hex='1EB9', c='ẹ', w='e', base='e', accents=['dotbelowcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=1108, comment='ẹ E WITH DOT BELOW, LATIN SMALL LETTER'),
    'egrave': GD(name='egrave', uni=0x00E8, hex='00E8', c='è', w='e', bl='e', base='e', accents=['gravecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=169, comment='è E WITH GRAVE, LATIN SMALL LETTER'),
    ...
    'gbreve': GD(name='gbreve', uni=0x011F, hex='011F', c='ğ', base='g', accents=['brevecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=224, comment='ğ G WITH BREVE, LATIN SMALL LETTER'),
    'gcaron': GD(name='gcaron', uni=0x01E7, hex='01E7', c='ǧ', base='g', accents=['caroncmb'], srcName='uni01E7', isLower=True, anchors=['bottom', 'middle', 'top'], gid=424),
    'gcircumflex': GD(name='gcircumflex', uni=0x011D, hex='011D', c='ĝ', base='g', accents=['circumflexcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=222, comment='ĝ G WITH CIRCUMFLEX, LATIN SMALL LETTER'),
    'gcommaaccent': GD(name='gcommaaccent', uni=0x0123, hex='0123', c='ģ', base='g', isLower=True, anchors=['bottom', 'middle', 'top'], gid=228),
    'gdotaccent': GD(name='gdotaccent', uni=0x0121, hex='0121', c='ġ', base='g', accents=['dotaccentcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=226),
    'germandbls': GD(name='germandbls', uni=0x00DF, hex='00DF', c='ß', isLower=True, gid=160, comment='ß SHARP S, LATIN SMALL LETTER'),
    'gmacron': GD(name='gmacron', uni=0x1E21, hex='1E21', c='ḡ', base='g', accents=['macroncmb'], srcName='uni1E21', isLower=True, anchors=['bottom', 'middle', 'top'], gid=956),
    ...
    'guillemotleft': GD(name='guillemotleft', uni=0x00AB, hex='00AB', l2r='guillemotleft', c='«', isLower=True, gid=108),
    ...
    'gravecmb': GD(name='gravecmb', uni=0x0300, hex='0300', c='̀', w='0', isLower=True, anchors=['_top', 'top'], gid=487),
    'gravecmb.uc': GD(name='gravecmb.uc', w='0', isLower=True, anchors=['_top', 'top']),
    ...
    'hcircumflex': GD(name='hcircumflex', uni=0x0125, hex='0125', c='ĥ', base='h', accents=['circumflexcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=230, comment='ĥ H WITH CIRCUMFLEX, LATIN SMALL LETTER'),
    'hdieresis': GD(name='hdieresis', uni=0x1E27, hex='1E27', c='ḧ', base='h', accents=['dieresiscmb'], srcName='uni1E27', isLower=True, anchors=['bottom', 'middle', 'top'], gid=962),
    'hdotbelow': GD(name='hdotbelow', uni=0x1E25, hex='1E25', c='ḥ', base='h', accents=['dotbelowcmb'], srcName='uni1E25', isLower=True, anchors=['bottom', 'middle', 'top'], gid=960),
    
    'hungarumlautcmb': GD(name='hungarumlautcmb', uni=0x030B, hex='030B', c='̋', w='0', isLower=True, anchors=['_top', 'top'], gid=497),
    'hungarumlautcmb.uc': GD(name='hungarumlautcmb.uc', w='0', src='hungarumlautcmb', isLower=True, anchors=['_top', 'top'], gid=497),

    # i

    'i': GD(name='i', uni=0x0069, hex='0069', c='i', l='off', w='idotless', isLower=True, anchors=['bottom', 'middle', 'ogonek', 'top'], gid=75, comment='i'),
    'iacute': GD(name='iacute', uni=0x00ED, hex='00ED', c='í', w='idotless', bl='idotless', base='idotless', accents=['acutecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=174, comment='í I WITH ACUTE, LATIN SMALL LETTER'),
    'ibreve': GD(name='ibreve', uni=0x012D, hex='012D', c='ĭ', w='idotless', bl='idotless', base='idotless', accents=['brevecmb'], isLower=True, anchors=['top'], gid=238, comment='ĭ I WITH BREVE, LATIN SMALL LETTER'),
    'icaron': GD(name='icaron', uni=0x01D0, hex='01D0', c='ǐ', w='idotless', bl='idotless', base='idotless', accents=['caroncmb'], srcName='uni01D0', isLower=True, anchors=['top'], gid=401),
    'icircumflex': GD(name='icircumflex', uni=0x00EE, hex='00EE', c='î', w='idotless', bl='idotless', base='idotless', accents=['circumflexcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=175, comment='î I WITH CIRCUMFLEX, LATIN SMALL LETTER'),
    'idieresis': GD(name='idieresis', uni=0x00EF, hex='00EF', c='ï', w='idotless', bl='idotless', base='idotless', accents=['dieresiscmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=176, comment='ï I WITH DIAERESIS, LATIN SMALL LETTER'),
    'idotbelow': GD(name='idotbelow', uni=0x1ECB, hex='1ECB', c='ị', w='idotless', bl='idotless', base='i', accents=['dotbelowcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=1126, comment='ị I WITH DOT BELOW, LATIN SMALL LETTER'),
    'idotless': GD(name='idotless', uni=0x0131, hex='0131', c='ı', l='l', r='off', isLower=True, anchors=['bottom', 'middle', 'ogonek', 'top'], gid=242),
    'igrave': GD(name='igrave', uni=0x00EC, hex='00EC', c='ì', w='idotless', bl='idotless', base='idotless', accents=['gravecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=173, comment='ì I WITH GRAVE, LATIN SMALL LETTER'),
    'imacron': GD(name='imacron', uni=0x012B, hex='012B', c='ī', w='idotless', bl='idotless', base='idotless', accents=['macroncmb'], isLower=True, anchors=['top'], gid=236, comment='ī I WITH MACRON, LATIN SMALL LETTER'),
    'iogonek': GD(name='iogonek', uni=0x012F, hex='012F', c='į', base='i', accents=['ogonekcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=240, comment='į I WITH OGONEK, LATIN SMALL LETTER'),
    'istroke': GD(name='istroke', uni=0x0268, hex='0268', c='ɨ', l='hyphen', r='hyphen', isLower=True),
    'itilde': GD(name='itilde', uni=0x0129, hex='0129', c='ĩ', bl='idotless', base='idotless', accents=['tildecmb'], isLower=True, anchors=['bottom', 'middle', 'ogonek', 'top'], gid=234, comment='ĩ I WITH TILDE, LATIN SMALL LETTER'),
    ...
    'kcommaaccent': GD(name='kcommaaccent', uni=0x0137, hex='0137', c='ķ', base='k', accents=['cedillacmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=248),
    ...
    'lacute': GD(name='lacute', uni=0x013A, hex='013A', c='ĺ', w='l', bl='l', base='l', accents=['acutecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=251, comment='ĺ L WITH ACUTE, LATIN SMALL LETTER'),
    'lcaron': GD(name='lcaron', uni=0x013E, hex='013E', c='ľ', rightMin='minRight', base='l', accents=['caronvertcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=255, comment='ľ L WITH CARON, LATIN SMALL LETTER'),
    'lcommaaccent': GD(name='lcommaaccent', uni=0x013C, hex='013C', c='ļ', w='l', base='l', accents=['cedillacmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=253),
    ...
    'macroncmb': GD(name='macroncmb', uni=0x0304, hex='0304', c='̄', w='0', srcName='uni0304', isLower=True, anchors=['_top', 'top']),
    'macroncmb.uc': GD(name='macroncmb.uc', w='0', base='macroncmb', isLower=True, anchors=['_top', 'top']),
    ...
    'ncommaaccent': GD(name='ncommaaccent', uni=0x0146, hex='0146', c='ņ', base='n', accents=['cedillacmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=263),
    ...
    'oacute': GD(name='oacute', uni=0x00F3, hex='00F3', c='ó', l='o', r='o', base='o', accents=['acutecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=180, comment='ó O WITH ACUTE, LATIN SMALL LETTER'),
    'obreve': GD(name='obreve', uni=0x014F, hex='014F', c='ŏ', w='o', bl='o', base='o', accents=['brevecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=272, comment='ŏ O WITH BREVE, LATIN SMALL LETTER'),
    ...
    'ocircumflex': GD(name='ocircumflex', uni=0x00F4, hex='00F4', c='ô', w='o', bl='o', base='o', accents=['circumflexcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=181, comment='ô O WITH CIRCUMFLEX, LATIN SMALL LETTER'),
    'odieresis': GD(name='odieresis', uni=0x00F6, hex='00F6', c='ö', w='o', bl='o', base='o', accents=['dieresiscmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=183, comment='ö O WITH DIAERESIS, LATIN SMALL LETTER'),
    'odotbelow': GD(name='odotbelow', uni=0x1ECD, hex='1ECD', c='ọ', w='o', bl='o', base='o', accents=['dotbelowcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=1128, comment='ọ O WITH DOT BELOW, LATIN SMALL LETTER'),
    ...
    'ograve': GD(name='ograve', uni=0x00F2, hex='00F2', c='ò', l='o', r='o', base='o', accents=['gravecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=179, comment='ò O WITH GRAVE, LATIN SMALL LETTER'),
    'ohungarumlaut': GD(name='ohungarumlaut', uni=0x0151, hex='0151', c='ő', w='o', base='o', accents=['hungarumlautcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=274),
    'omacron': GD(name='omacron', uni=0x014D, hex='014D', c='ō', l='o', r='o', base='o', accents=['macroncmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=270, comment='ō O WITH MACRON, LATIN SMALL LETTER'),
    ...
    'otilde': GD(name='otilde', uni=0x00F5, hex='00F5', c='õ', base='o', accents=['tildecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=182, comment='õ O WITH TILDE, LATIN SMALL LETTER'),
    ...
    'ringcmb': GD(name='ringcmb', uni=0x030A, hex='030A', c='̊', w='0', isLower=True, anchors=['_top', 'top'], gid=496),
    ...
    'tcaron': GD(name='tcaron', uni=0x0165, hex='0165', c='ť', base='t', accents=['caronvertcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=294, comment='ť T WITH CARON, LATIN SMALL LETTER'),
    'tcedilla': GD(name='tcedilla', uni=0x0163, hex='0163', c='ţ', base='t', accents=['cedillacmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=292, comment='ţ T WITH CEDILLA, LATIN SMALL LETTER'),
    'tcommaaccent': GD(name='tcommaaccent', uni=0x021B, hex='021B', c='ț', base='t', accents=['cedillacmb'], srcName='uni021B', isLower=True, anchors=['bottom', 'middle', 'top'], gid=452, comment='ț T WITH COMMA BELOW, LATIN SMALL LETTER'),
    ...
    'uacute': GD(name='uacute', uni=0x00FA, hex='00FA', c='ú', l='u', r='u', base='u', accents=['acutecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=187, comment='ú U WITH ACUTE, LATIN SMALL LETTER'),
    'ubreve': GD(name='ubreve', uni=0x016D, hex='016D', c='ŭ', l='u', r='u', base='u', accents=['brevecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=302, comment='ŭ U WITH BREVE, LATIN SMALL LETTER'),
    'ucaron': GD(name='ucaron', uni=0x01D4, hex='01D4', c='ǔ', l='u', r='u', base='u', accents=['caroncmb'], srcName='uni01D4', isLower=True, anchors=['bottom', 'middle', 'top'], gid=405),
    'ucircumflex': GD(name='ucircumflex', uni=0x00FB, hex='00FB', c='û', l='u', r='u', base='u', accents=['circumflexcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=188, comment='û U WITH CIRCUMFLEX, LATIN SMALL LETTER'),
    'udieresis': GD(name='udieresis', uni=0x00FC, hex='00FC', c='ü', l='u', r='u', base='u', accents=['dieresiscmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=189, comment='ü U WITH DIAERESIS, LATIN SMALL LETTER'),
    'udotbelow': GD(name='udotbelow', uni=0x1EE5, hex='1EE5', c='ụ', l='u', r='u', base='u', accents=['dotbelowcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=1152, comment='ụ U WITH DOT BELOW, LATIN SMALL LETTER'),
    'ugrave': GD(name='ugrave', uni=0x00F9, hex='00F9', c='ù', l='u', r='u', base='u', accents=['gravecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=186, comment='ù U WITH GRAVE, LATIN SMALL LETTER'),
    'uhungarumlaut': GD(name='uhungarumlaut', uni=0x0171, hex='0171', c='ű', l='u', w='u', base='u', accents=['hungarumlautcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=306, comment='ű U WITH DOUBLE ACUTE, LATIN SMALL LETTER'),
    'umacron': GD(name='umacron', uni=0x016B, hex='016B', c='ū', l='u', r='u', base='u', accents=['macroncmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=300, comment='ū U WITH MACRON, LATIN SMALL LETTER'),
    ...
    'uring': GD(name='uring', uni=0x016F, hex='016F', c='ů', base='u', accents=['ringcmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=304, comment='ů U WITH RING ABOVE, LATIN SMALL LETTER'),
    'utilde': GD(name='utilde', uni=0x0169, hex='0169', c='ũ', base='u', accents=['tildecmb'], isLower=True, anchors=['bottom', 'middle', 'top'], gid=298, comment='ũ U WITH TILDE, LATIN SMALL LETTER'),
    ...
    'zero': GD(g2='zero', g1='zero', l2r='zero', uni=0x0030, c='0', name='zero', comment='0 Digits, ASCII', useSkewRotate=True, addItalicExtremePoints=True),
    'zeroslash': GD(g2='zero', g1='zero', l='zero', w='zero', name='zeroslash', base='zero', src='slash', comment='0 Digits, ASCII'),
    'one': GD(g2='one', g1='one', l2r='one', uni=0x0031, c='1', name='one', comment='1'),
    'two': GD(g2='two', g1='two', l2r='two', uni=0x0032, c='2', name='two', comment='2'),
    'two.alt1': GD(g2='two', g1='two', l='two', r='two', name='two.alt1', src='two', comment='2 alternative'),
    'three': GD(g2='three', g1='three', l2r='three', uni=0x0033, c='3', name='three', comment='3'),
    'four': GD(g2='four', g1='four', uni=0x0034, c='4', name='four', comment='4'),
    'five': GD(g2='five', g1='five', l2r='five', uni=0x0035, c='5', name='five', comment='5'),
    'five.alt1': GD(g2='five', g1='five', l='five', r='five', name='five.alt1', src='five', comment='5 alternative'),
    'six': GD(g2='six', g1='six',  l2r='six', uni=0x0036, c='6', name='six', comment='6'),
    'seven': GD(g2='seven', g1='seven', uni=0x0037, c='7', name='seven', comment='7'),
    'seven.alt1': GD(g2='seven', g1='seven', l='seven', r='seven', name='seven.alt1', src='seven', comment='7 alternative'),
    'eight': GD(g2='eight', g1='eight', l2r='eight', uni=0x0038, c='8', name='eight', comment='8'),
    'nine': GD(g2='nine', g1='nine', l2r='six', r2l='six', uni=0x0039, c='9', name='nine', comment='9'),

}

# Used by GlyphSet class to add small cap glyph data records. 
SC_NAMES = (
    'A', 'AE', 'Aacute', 'Abreve', 'Acaron', 'Acircumflex', 'Adieresis', 'Adotbelow', 'Agrave', 'Amacron', 'Aogonek', 'Aring', 'Atilde', 
    'B', 'Bdotbelow', 'Bhook', 
...
GDS['caronvertcmb'] = GD(name='caronvertcmb', w=0, anchors=['top', '_top'])
