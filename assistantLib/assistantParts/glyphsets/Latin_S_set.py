...
SC_NAMES = (
    ...
    'Kje-cy', 'Koppa-cy', 'Ksi-cy', 'Lje-cy', 'Nje-cy', 'O-cy', 'Obarred-cy', 'Obarreddieresis-cy', 'Odieresis-cy', 'Omega-cy', 'Palochka-cy', 'Pe-cy', 
    ...
    'Yuslittleiotified-cy', 'Ze-cy', 'Zedescender-cy', 'Zedieresis-cy', 'Zhe-cy', 'Zhebreve-cy', 'Zhedescender-cy', 'Zhedieresis-cy',
