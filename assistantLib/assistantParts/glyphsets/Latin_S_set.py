...
LATIN_S_SET = GDS = {
    ...
    'bracketleft.sc': GD(name='bracketleft.sc', l='bracketleft', r='bracketleft', base='bracketleft', isLower=True, comment='[ square bracket, opening'),
    ...
    'bracketright.sc': GD(name='bracketright.sc', l='bracketright', r='bracketright', base='bracketright', isLower=True, comment='] square bracket, opening'),
