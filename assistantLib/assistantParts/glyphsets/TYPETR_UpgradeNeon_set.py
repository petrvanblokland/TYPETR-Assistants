...
try:
    ...
    from TYPETR_full_set import TYPETR_GlyphSet
...
class TYPETR_UpgradeNeonGlyphSet(TYPETR_GlyphSet):
    ...
    gds['bitcoin.lc'] = GD(name='bitcoin.lc', base='B.sc')
    ...
    gds['dollar.lc'] = GD(name='dollar.lc', base='s')
    ...
    gds['germandbls.sc'] = GD(name='germandbls.sc', base='S.sc')
    ...
    gds['idotaccent'] = GD(name='idotaccent', base='dotlessi', accents=('dotaccentcmb, dotaccentcmb'))
    ...
    gds['percent.lc'] = GD(name='percent.lc', base='zero.numr', accents=('fraction, zero.dnom'))
    gds['percent.tab'] = GD(name='percent.tab')
    gds['periodcmb'] = GD(name='periodcmb')
    gds['perthousand.lc'] = GD(name='perthousand.lc', base='zero.numr', accents=('fraction, zero.dnom, zero.dnom, fraction, zero.dnom, zero.dnom'))
    ...
    gds['yen.lc'] = GD(name='yen.lc', base='yen.sc')
