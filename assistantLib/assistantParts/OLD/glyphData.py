...
#
#    TYPETR-TypeLib
#    (c) 2019+ buro@petr.com, www.petr.com
#
...
GLYPH_DATA = gds = {
    ...
    'cent.tab': GD(g2='tab', g1='tab', l=CENTER, w=TAB_WDTH, name='cent.tab', base='cent', isLower=True, comment='¢ CENT SIGN TAB'),
    ...
    'comma.tab': GD(g2='tab', g1='tab', l=CENTER, w=TAB_WIDTH, name='comma.tab', base='comma', comment=', separator, decimal', anchors=[]),
    ...
    'dollar.tab': GD(g2='tab', g1='tab', l=CENTER, w=TAB_WIDTH, name='dollar.tab', src='dollar', height=CAP_HEIGHT, overshoot=CAP_OVERSHOOT, comment='$ milreis TAB'),
    'dollar.alt1.tab': GD(g2='tab', g1='tab', l=CENTER, w=TAB_WIDTH, name='dollar.alt1.tab', src='dollar.tab', height=CAP_HEIGHT, overshoot=CAP_OVERSHOOT, comment='$ milreis TAB'),
    ...
    'integral': GD(l=CENTER, w=TAB_WIDTH, uni=0x222b, c='∫', name='integral', src='f', anchors=[], copyFromDisplayRight=False, comment='∫ Integral Signs'),
    ...
    'period.tab': GD(g2='tab', g1='tab', l=CENTER, w=TAB_WIDTH, name='period.tab', base='period', comment='. point, decimal', anchors=[]),
    ...
    'sterling.tab': GD(g2='tab', g1='tab', l=CENTER, w=TAB_WIDTH, name='sterling.tab', src='sterling', comment='£ sterling, pound TAB', height=CAP_HEIGHT, overshoot=CAP_OVERSHOOT),
